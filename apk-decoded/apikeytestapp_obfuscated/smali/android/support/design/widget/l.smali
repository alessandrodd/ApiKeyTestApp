...
.method constructor <init>(Landroid/support/design/widget/ab;Landroid/support/design/widget/p;)V
    ...
    invoke-direct {p0, p1, p2}, Landroid/support/design/widget/k;-><init>(Landroid/support/design/widget/ab;Landroid/support/design/widget/p;)V
...
.method public a()F
    ...
    iget-object v0, p0, Landroid/support/design/widget/l;->t:Landroid/support/design/widget/ab;
...
.method a(FF)V
    ...
    :goto_0
    iget-object v0, p0, Landroid/support/design/widget/l;->u:Landroid/support/design/widget/p;
    ...
    iget-object v2, p0, Landroid/support/design/widget/l;->t:Landroid/support/design/widget/ab;
    ...
    iget-object v3, p0, Landroid/support/design/widget/l;->t:Landroid/support/design/widget/ab;
    ...
    sget-object v2, Landroid/support/design/widget/l;->a:Landroid/view/animation/Interpolator;
    ...
    iget-object v7, p0, Landroid/support/design/widget/l;->t:Landroid/support/design/widget/ab;

    invoke-virtual {v7}, Landroid/support/design/widget/ab;->getTranslationZ()F
    ...
    sget-object v0, Landroid/support/design/widget/l;->a:Landroid/view/animation/Interpolator;

    invoke-virtual {v2, v0}, Landroid/animation/AnimatorSet;->setInterpolator(Landroid/animation/TimeInterpolator;)V

    sget-object v0, Landroid/support/design/widget/l;->r:[I
    ...
    invoke-virtual {v0, v1}, Landroid/support/design/widget/ab;->setStateListAnimator(Landroid/animation/StateListAnimator;)V
...
.method a(I)V
    ...
    :cond_0
    invoke-super {p0, p1}, Landroid/support/design/widget/k;->a(I)V
...
.method a(Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;II)V
    ...
    invoke-virtual {p0, p4, p1}, Landroid/support/design/widget/l;->a(ILandroid/content/res/ColorStateList;)Landroid/support/design/widget/e;

    move-result-object v0

    iput-object v0, p0, Landroid/support/design/widget/l;->k:Landroid/support/design/widget/e;
    ...
    iget-object v3, p0, Landroid/support/design/widget/l;->k:Landroid/support/design/widget/e;
    ...
    :cond_1
    iput-object v4, p0, Landroid/support/design/widget/l;->k:Landroid/support/design/widget/e;
...
.method b(Landroid/graphics/Rect;)V
    ...
    iput-object v0, p0, Landroid/support/design/widget/l;->v:Landroid/graphics/drawable/InsetDrawable;

    iget-object v0, p0, Landroid/support/design/widget/l;->u:Landroid/support/design/widget/p;

    iget-object v1, p0, Landroid/support/design/widget/l;->v:Landroid/graphics/drawable/InsetDrawable;
