...
.method public constructor <init>(II)V
    ...
    iput-object v0, p0, Landroid/support/design/widget/CoordinatorLayout$c;->m:Landroid/graphics/Rect;
...
.method constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget-object v0, Landroid/support/design/a$h;->CoordinatorLayout_Layout:[I

    invoke-virtual {p1, p2, v0}, Landroid/content/Context;->obtainStyledAttributes(Landroid/util/AttributeSet;[I)Landroid/content/res/TypedArray;

    move-result-object v0

    sget v1, Landroid/support/design/a$h;->CoordinatorLayout_Layout_android_layout_gravity:I
    ...
    sget v1, Landroid/support/design/a$h;->CoordinatorLayout_Layout_layout_anchor:I
    ...
    sget v1, Landroid/support/design/a$h;->CoordinatorLayout_Layout_layout_anchorGravity:I
    ...
    sget v1, Landroid/support/design/a$h;->CoordinatorLayout_Layout_layout_keyline:I
    ...
    sget v1, Landroid/support/design/a$h;->CoordinatorLayout_Layout_layout_insetEdge:I
    ...
    sget v1, Landroid/support/design/a$h;->CoordinatorLayout_Layout_layout_dodgeInsetEdges:I
    ...
    sget v1, Landroid/support/design/a$h;->CoordinatorLayout_Layout_layout_behavior:I
    ...
    iput-object v1, p0, Landroid/support/design/widget/CoordinatorLayout$c;->a:Landroid/support/design/widget/CoordinatorLayout$a;

    :cond_0
    invoke-virtual {v0}, Landroid/content/res/TypedArray;->recycle()V

    iget-object v0, p0, Landroid/support/design/widget/CoordinatorLayout$c;->a:Landroid/support/design/widget/CoordinatorLayout$a;

    if-eqz v0, :cond_1

    iget-object v0, p0, Landroid/support/design/widget/CoordinatorLayout$c;->a:Landroid/support/design/widget/CoordinatorLayout$a;

    invoke-virtual {v0, p0}, Landroid/support/design/widget/CoordinatorLayout$a;->a(Landroid/support/design/widget/CoordinatorLayout$c;)V
...
.method private a(Landroid/view/View;Landroid/support/design/widget/CoordinatorLayout;)V
    ...
    iput-object v3, p0, Landroid/support/design/widget/CoordinatorLayout$c;->l:Landroid/view/View;

    iput-object v3, p0, Landroid/support/design/widget/CoordinatorLayout$c;->k:Landroid/view/View;
    ...
    iget v3, p0, Landroid/support/design/widget/CoordinatorLayout$c;->f:I
...
.method private a(Landroid/view/View;I)Z
    ...
    iget v0, v0, Landroid/support/design/widget/CoordinatorLayout$c;->g:I
    ...
    iget v1, p0, Landroid/support/design/widget/CoordinatorLayout$c;->h:I
...
.method public a(Landroid/support/design/widget/CoordinatorLayout$a;)V
    ...
    :cond_0
    iput-object p1, p0, Landroid/support/design/widget/CoordinatorLayout$c;->a:Landroid/support/design/widget/CoordinatorLayout$a;
    ...
    invoke-virtual {p1, p0}, Landroid/support/design/widget/CoordinatorLayout$a;->a(Landroid/support/design/widget/CoordinatorLayout$c;)V
...
.method a(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;)Z
    ...
    :cond_0
    iget-boolean v1, p0, Landroid/support/design/widget/CoordinatorLayout$c;->o:Z
...
.method b(I)Z
    ...
    :pswitch_0
    iget-boolean v0, p0, Landroid/support/design/widget/CoordinatorLayout$c;->p:Z

    goto :goto_0

    :pswitch_1
    iget-boolean v0, p0, Landroid/support/design/widget/CoordinatorLayout$c;->q:Z
