.class public Landroid/support/h/j;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/h/j;->n:[Ljava/lang/String;

    new-instance v0, Landroid/support/h/j$1;

    invoke-direct {v0}, Landroid/support/h/j$1;-><init>()V

    sput-object v0, Landroid/support/h/j;->o:Landroid/animation/TypeEvaluator;

    new-instance v0, Landroid/support/h/j$2;

    const-class v1, Landroid/graphics/Matrix;

    const-string v2, "animatedTransform"

    invoke-direct {v0, v1, v2}, Landroid/support/h/j$2;-><init>(Ljava/lang/Class;Ljava/lang/String;)V

    sput-object v0, Landroid/support/h/j;->p:Landroid/util/Property;
...
.method private a(Landroid/widget/ImageView;)Landroid/animation/ObjectAnimator;
    ...
    sget-object v0, Landroid/support/h/j;->p:Landroid/util/Property;

    sget-object v1, Landroid/support/h/j;->o:Landroid/animation/TypeEvaluator;
...
.method private a(Landroid/widget/ImageView;Landroid/graphics/Matrix;Landroid/graphics/Matrix;)Landroid/animation/ObjectAnimator;
    ...
    new-instance v1, Landroid/support/h/at$a;

    invoke-direct {v1}, Landroid/support/h/at$a;-><init>()V
...
.method private static b(Landroid/widget/ImageView;)Landroid/graphics/Matrix;
    ...
    sget-object v0, Landroid/support/h/j$3;->a:[I
    ...
    :pswitch_0
    invoke-static {p0}, Landroid/support/h/j;->c(Landroid/widget/ImageView;)Landroid/graphics/Matrix;
    ...
    :pswitch_1
    invoke-static {p0}, Landroid/support/h/j;->d(Landroid/widget/ImageView;)Landroid/graphics/Matrix;
...
.method private d(Landroid/support/h/au;)V
    ...
    invoke-static {v0}, Landroid/support/h/j;->b(Landroid/widget/ImageView;)Landroid/graphics/Matrix;
...
.method public a(Landroid/view/ViewGroup;Landroid/support/h/au;Landroid/support/h/au;)Landroid/animation/Animator;
    ...
    :cond_3
    iget-object v2, p2, Landroid/support/h/au;->a:Ljava/util/Map;
    ...
    iget-object v3, p3, Landroid/support/h/au;->a:Ljava/util/Map;
    ...
    invoke-static {v0}, Landroid/support/h/t;->a(Landroid/widget/ImageView;)V
    ...
    :cond_8
    invoke-direct {p0, v0}, Landroid/support/h/j;->a(Landroid/widget/ImageView;)Landroid/animation/ObjectAnimator;

    move-result-object v1

    :goto_2
    invoke-static {v0, v1}, Landroid/support/h/t;->a(Landroid/widget/ImageView;Landroid/animation/Animator;)V
    ...
    sget-object v2, Landroid/support/h/x;->a:Landroid/graphics/Matrix;
    ...
    :cond_b
    sget-object v1, Landroid/support/h/j;->p:Landroid/util/Property;

    invoke-virtual {v1, v0, v2}, Landroid/util/Property;->set(Ljava/lang/Object;Ljava/lang/Object;)V

    invoke-direct {p0, v0, v2, v3}, Landroid/support/h/j;->a(Landroid/widget/ImageView;Landroid/graphics/Matrix;Landroid/graphics/Matrix;)Landroid/animation/ObjectAnimator;
...
.method public a(Landroid/support/h/au;)V
    ...
    invoke-direct {p0, p1}, Landroid/support/h/j;->d(Landroid/support/h/au;)V
...
.method public a()[Ljava/lang/String;
    ...
    sget-object v0, Landroid/support/h/j;->n:[Ljava/lang/String;
