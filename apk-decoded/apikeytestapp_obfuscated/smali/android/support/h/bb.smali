.class Landroid/support/h/bb;
.super Ljava/lang/Object;

# interfaces
.implements Landroid/support/h/bd;
...
.method private static a(Landroid/animation/LayoutTransition;)V
    ...
    sget-boolean v0, Landroid/support/h/bb;->g:Z
    ...
    sput-object v0, Landroid/support/h/bb;->f:Ljava/lang/reflect/Method;

    sget-object v0, Landroid/support/h/bb;->f:Ljava/lang/reflect/Method;
    ...
    :goto_0
    sput-boolean v3, Landroid/support/h/bb;->g:Z
...
.method public a(Landroid/view/ViewGroup;)Landroid/support/h/az;
    ...
    invoke-static {p1}, Landroid/support/h/ax;->a(Landroid/view/ViewGroup;)Landroid/support/h/ax;
...
.method public a(Landroid/view/ViewGroup;Z)V
    ...
    sget-object v1, Landroid/support/h/bb;->c:Landroid/animation/LayoutTransition;

    if-nez v1, :cond_0

    new-instance v1, Landroid/support/h/bb$1;

    invoke-direct {v1, p0}, Landroid/support/h/bb$1;-><init>(Landroid/support/h/bb;)V

    sput-object v1, Landroid/support/h/bb;->c:Landroid/animation/LayoutTransition;
    ...
    invoke-static {v0}, Landroid/support/h/bb;->a(Landroid/animation/LayoutTransition;)V
    ...
    sget v1, Landroid/support/h/ai$b;->transition_layout_save:I

    invoke-virtual {p1, v1, v0}, Landroid/view/ViewGroup;->setTag(ILjava/lang/Object;)V

    :cond_2
    sget-object v0, Landroid/support/h/bb;->c:Landroid/animation/LayoutTransition;
    ...
    sget-boolean v1, Landroid/support/h/bb;->e:Z
    ...
    sput-object v1, Landroid/support/h/bb;->d:Ljava/lang/reflect/Field;

    sget-object v1, Landroid/support/h/bb;->d:Ljava/lang/reflect/Field;
    ...
    :goto_1
    sput-boolean v4, Landroid/support/h/bb;->e:Z
    ...
    :cond_7
    sget v0, Landroid/support/h/ai$b;->transition_layout_save:I
