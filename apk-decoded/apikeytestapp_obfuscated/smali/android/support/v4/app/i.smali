...
.field private h:Landroid/support/v4/app/q;
...
.method constructor <init>(Landroid/app/Activity;Landroid/content/Context;Landroid/os/Handler;I)V
    ...
    iput-object p2, p0, Landroid/support/v4/app/i;->b:Landroid/content/Context;

    iput-object p3, p0, Landroid/support/v4/app/i;->e:Landroid/os/Handler;
...
.method constructor <init>(Landroid/support/v4/app/f;)V
    ...
    iget-object v0, p1, Landroid/support/v4/app/f;->c:Landroid/os/Handler;
...
# virtual methods
.method a(Ljava/lang/String;ZZ)Landroid/support/v4/app/q;
    .locals 2

    iget-object v0, p0, Landroid/support/v4/app/i;->f:Landroid/support/v4/g/l;
    ...
    iput-object v0, p0, Landroid/support/v4/app/i;->f:Landroid/support/v4/g/l;
    ...
    invoke-direct {v0, p1, p0, p2}, Landroid/support/v4/app/q;-><init>(Ljava/lang/String;Landroid/support/v4/app/i;Z)V

    iget-object v1, p0, Landroid/support/v4/app/i;->f:Landroid/support/v4/g/l;
    ...
    iget-boolean v1, v0, Landroid/support/v4/app/q;->e:Z
...
.method a(Landroid/support/v4/g/l;)V
    ...
    invoke-virtual {v0, p0}, Landroid/support/v4/app/q;->a(Landroid/support/v4/app/i;)V
    ...
    :cond_0
    iput-object p1, p0, Landroid/support/v4/app/i;->f:Landroid/support/v4/g/l;
...
.method a(Ljava/lang/String;)V
    ...
    iget-boolean v1, v0, Landroid/support/v4/app/q;->f:Z
...
.method a(Z)V
    ...
    iput-boolean p1, p0, Landroid/support/v4/app/i;->g:Z

    iget-object v0, p0, Landroid/support/v4/app/i;->h:Landroid/support/v4/app/q;
...
.method public b()Landroid/view/LayoutInflater;
    ...
    iget-object v0, p0, Landroid/support/v4/app/i;->b:Landroid/content/Context;
...
.method k()V
    ...
    invoke-virtual {p0, v0, v1, v2}, Landroid/support/v4/app/i;->a(Ljava/lang/String;ZZ)Landroid/support/v4/app/q;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v4/app/i;->h:Landroid/support/v4/app/q;
...
.method m()V
    ...
    invoke-virtual {v1}, Landroid/support/v4/app/q;->e()V

    invoke-virtual {v1}, Landroid/support/v4/app/q;->g()V
...
.method n()Landroid/support/v4/g/l;
    ...
    new-array v4, v3, [Landroid/support/v4/app/q;
    ...
    :cond_0
    invoke-virtual {p0}, Landroid/support/v4/app/i;->j()Z
    ...
    iget-boolean v6, v5, Landroid/support/v4/app/q;->f:Z

    if-nez v6, :cond_2

    if-eqz v2, :cond_2

    iget-boolean v6, v5, Landroid/support/v4/app/q;->e:Z

    if-nez v6, :cond_1

    invoke-virtual {v5}, Landroid/support/v4/app/q;->b()V

    :cond_1
    invoke-virtual {v5}, Landroid/support/v4/app/q;->d()V
    ...
    :cond_3
    invoke-virtual {v5}, Landroid/support/v4/app/q;->h()V

    iget-object v6, p0, Landroid/support/v4/app/i;->f:Landroid/support/v4/g/l;

    iget-object v5, v5, Landroid/support/v4/app/q;->d:Ljava/lang/String;
