...
.field static final e:Ljava/lang/String; = "android.support.dataRemoteInputs"

.field static final f:Ljava/lang/String; = "android.support.groupKey"

.field static final g:Ljava/lang/String; = "android.support.isGroupSummary"

.field static final h:Ljava/lang/String; = "android.support.sortKey"

.field static final i:Ljava/lang/String; = "android.support.useSideChannel"

.field static final j:Ljava/lang/String; = "android.support.allowGeneratedReplies"

.field private static final k:Ljava/lang/String; = "icon"

.field private static final l:Ljava/lang/String; = "title"

.field private static final m:Ljava/lang/String; = "actionIntent"

.field private static final n:Ljava/lang/String; = "extras"

.field private static final o:Ljava/lang/String; = "remoteInputs"

.field private static final p:Ljava/lang/String; = "dataOnlyRemoteInputs"
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/app/as;->q:Ljava/lang/Object;

    new-instance v0, Ljava/lang/Object;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Landroid/support/v4/app/as;->t:Ljava/lang/Object;
...
.method public static a(Landroid/app/Notification$Builder;Landroid/support/v4/app/aq$a;)Landroid/os/Bundle;
    ...
    invoke-static {v2}, Landroid/support/v4/app/ba;->a([Landroid/support/v4/app/az$a;)[Landroid/os/Bundle;
    ...
    :cond_0
    invoke-virtual {p1}, Landroid/support/v4/app/aq$a;->h()[Landroid/support/v4/app/az$a;
...
.method public static a(Landroid/app/Notification;)Landroid/os/Bundle;
    ...
    sget-object v2, Landroid/support/v4/app/as;->q:Ljava/lang/Object;

    monitor-enter v2

    :try_start_0
    sget-boolean v0, Landroid/support/v4/app/as;->s:Z
    ...
    :cond_0
    :try_start_1
    sget-object v0, Landroid/support/v4/app/as;->r:Ljava/lang/reflect/Field;
    ...
    sput-boolean v0, Landroid/support/v4/app/as;->s:Z
    :try_end_1
    ...
    sput-object v0, Landroid/support/v4/app/as;->r:Ljava/lang/reflect/Field;
    ...
    sget-object v3, Landroid/support/v4/app/as;->r:Ljava/lang/reflect/Field;
...
.method private static a(Landroid/support/v4/app/aq$a;)Landroid/os/Bundle;
    .locals 4
...
.method public static a(Landroid/app/Notification;ILandroid/support/v4/app/aq$a$a;Landroid/support/v4/app/az$a$a;)Landroid/support/v4/app/aq$a;
    ...
    sget-object v7, Landroid/support/v4/app/as;->t:Ljava/lang/Object;

    monitor-enter v7

    :try_start_0
    invoke-static {p0}, Landroid/support/v4/app/as;->c(Landroid/app/Notification;)[Ljava/lang/Object;
    ...
    :goto_0
    sget-object v0, Landroid/support/v4/app/as;->w:Ljava/lang/reflect/Field;

    invoke-virtual {v0, v1}, Ljava/lang/reflect/Field;->getInt(Ljava/lang/Object;)I

    move-result v2

    sget-object v0, Landroid/support/v4/app/as;->x:Ljava/lang/reflect/Field;
    ...
    sget-object v0, Landroid/support/v4/app/as;->y:Ljava/lang/reflect/Field;
    ...
    invoke-static/range {v0 .. v5}, Landroid/support/v4/app/as;->a(Landroid/support/v4/app/aq$a$a;Landroid/support/v4/app/az$a$a;ILjava/lang/CharSequence;Landroid/app/PendingIntent;Landroid/os/Bundle;)Landroid/support/v4/app/aq$a;
    :try_end_0
    ...
    sput-boolean v0, Landroid/support/v4/app/as;->z:Z
...
.method private static a(Landroid/os/Bundle;Landroid/support/v4/app/aq$a$a;Landroid/support/v4/app/az$a$a;)Landroid/support/v4/app/aq$a;
    .locals 8
    ...
    invoke-static {p0, v0}, Landroid/support/v4/app/n;->a(Landroid/os/Bundle;Ljava/lang/String;)[Landroid/os/Bundle;

    move-result-object v0

    invoke-static {v0, p2}, Landroid/support/v4/app/ba;->a([Landroid/os/Bundle;Landroid/support/v4/app/az$a$a;)[Landroid/support/v4/app/az$a;
...
.method public static a(Landroid/support/v4/app/aq$a$a;Landroid/support/v4/app/az$a$a;ILjava/lang/CharSequence;Landroid/app/PendingIntent;Landroid/os/Bundle;)Landroid/support/v4/app/aq$a;
    .locals 8
    ...
    invoke-static {p5, v0}, Landroid/support/v4/app/n;->a(Landroid/os/Bundle;Ljava/lang/String;)[Landroid/os/Bundle;

    move-result-object v0

    invoke-static {v0, p1}, Landroid/support/v4/app/ba;->a([Landroid/os/Bundle;Landroid/support/v4/app/az$a$a;)[Landroid/support/v4/app/az$a;
...
.method public static a([Landroid/support/v4/app/aq$a;)Ljava/util/ArrayList;
    ...
    invoke-static {v3}, Landroid/support/v4/app/as;->a(Landroid/support/v4/app/aq$a;)Landroid/os/Bundle;
...
.method private static a()Z
    ...
    sget-boolean v2, Landroid/support/v4/app/as;->z:Z
    ...
    :cond_0
    :try_start_0
    sget-object v2, Landroid/support/v4/app/as;->v:Ljava/lang/reflect/Field;
    ...
    sput-object v2, Landroid/support/v4/app/as;->u:Ljava/lang/Class;

    sget-object v2, Landroid/support/v4/app/as;->u:Ljava/lang/Class;
    ...
    sput-object v2, Landroid/support/v4/app/as;->w:Ljava/lang/reflect/Field;
    ...
    sput-object v2, Landroid/support/v4/app/as;->x:Ljava/lang/reflect/Field;
    ...
    sput-object v2, Landroid/support/v4/app/as;->y:Ljava/lang/reflect/Field;
    ...
    sput-object v2, Landroid/support/v4/app/as;->v:Ljava/lang/reflect/Field;
...
.method public static a(Ljava/util/ArrayList;Landroid/support/v4/app/aq$a$a;Landroid/support/v4/app/az$a$a;)[Landroid/support/v4/app/aq$a;
    ...
    invoke-static {v0, p1, p2}, Landroid/support/v4/app/as;->a(Landroid/os/Bundle;Landroid/support/v4/app/aq$a$a;Landroid/support/v4/app/az$a$a;)Landroid/support/v4/app/aq$a;
...
.method public static b(Landroid/app/Notification;)I
    ...
    sget-object v1, Landroid/support/v4/app/as;->t:Ljava/lang/Object;
...
.method private static c(Landroid/app/Notification;)[Ljava/lang/Object;
    ...
    sget-object v2, Landroid/support/v4/app/as;->t:Ljava/lang/Object;

    monitor-enter v2

    :try_start_0
    invoke-static {}, Landroid/support/v4/app/as;->a()Z
    ...
    :cond_0
    :try_start_1
    sget-object v0, Landroid/support/v4/app/as;->v:Ljava/lang/reflect/Field;
