...
.method private static a(Landroid/support/v4/app/az$a;)Landroid/app/RemoteInput;
    .locals 2
...
.method static a(Landroid/support/v4/app/aq$b;)Landroid/os/Bundle;
    .locals 7
    ...
    invoke-virtual {p0}, Landroid/support/v4/app/aq$b;->e()[Ljava/lang/String;
    ...
    :cond_1
    invoke-virtual {p0}, Landroid/support/v4/app/aq$b;->a()[Ljava/lang/String;
    ...
    invoke-virtual {p0}, Landroid/support/v4/app/aq$b;->h()Landroid/support/v4/app/az$a;
    ...
    invoke-static {v0}, Landroid/support/v4/app/am;->a(Landroid/support/v4/app/az$a;)Landroid/app/RemoteInput;
    ...
    invoke-virtual {p0}, Landroid/support/v4/app/aq$b;->c()Landroid/app/PendingIntent;
    ...
    invoke-virtual {p0}, Landroid/support/v4/app/aq$b;->d()Landroid/app/PendingIntent;
    ...
    invoke-virtual {p0}, Landroid/support/v4/app/aq$b;->g()J
...
.method static a(Landroid/os/Bundle;Landroid/support/v4/app/aq$b$a;Landroid/support/v4/app/az$a$a;)Landroid/support/v4/app/aq$b;
    .locals 8
    ...
    invoke-static {v0, p2}, Landroid/support/v4/app/am;->a(Landroid/app/RemoteInput;Landroid/support/v4/app/az$a$a;)Landroid/support/v4/app/az$a;
    ...
    invoke-interface/range {v0 .. v7}, Landroid/support/v4/app/aq$b$a;->b([Ljava/lang/String;Landroid/support/v4/app/az$a;Landroid/app/PendingIntent;Landroid/app/PendingIntent;[Ljava/lang/String;J)Landroid/support/v4/app/aq$b;
...
.method private static a(Landroid/app/RemoteInput;Landroid/support/v4/app/az$a$a;)Landroid/support/v4/app/az$a;
    .locals 7
