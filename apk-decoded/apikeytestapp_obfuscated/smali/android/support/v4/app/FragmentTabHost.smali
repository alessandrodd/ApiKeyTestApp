...
.method private a(Ljava/lang/String;Landroid/support/v4/app/y;)Landroid/support/v4/app/y;
    ...
    .param p1    # Ljava/lang/String;
        ...
        .end annotation
    .end param
    .param p2    # Landroid/support/v4/app/y;
        .annotation build Landroid/support/annotation/ae;
        .end annotation
    .end param
    .annotation build Landroid/support/annotation/ae;
    ...
    iget-object v1, p0, Landroid/support/v4/app/FragmentTabHost;->d:Landroid/support/v4/app/t;

    invoke-virtual {v1}, Landroid/support/v4/app/t;->a()Landroid/support/v4/app/y;
    ...
    invoke-virtual {p2, v1}, Landroid/support/v4/app/y;->d(Landroid/support/v4/app/Fragment;)Landroid/support/v4/app/y;
    ...
    invoke-virtual {p2, v1, v2, v3}, Landroid/support/v4/app/y;->a(ILandroid/support/v4/app/Fragment;Ljava/lang/String;)Landroid/support/v4/app/y;
    ...
    invoke-virtual {p2, v1}, Landroid/support/v4/app/y;->e(Landroid/support/v4/app/Fragment;)Landroid/support/v4/app/y;
...
# virtual methods
.method public a(Landroid/content/Context;Landroid/support/v4/app/t;)V
    .locals 0
    ...
    iput-object p2, p0, Landroid/support/v4/app/FragmentTabHost;->d:Landroid/support/v4/app/t;
...
.method public a(Landroid/content/Context;Landroid/support/v4/app/t;I)V
    .locals 2
...
.method public a(Landroid/widget/TabHost$TabSpec;Ljava/lang/Class;Landroid/os/Bundle;)V
    ...
    iget-object v2, p0, Landroid/support/v4/app/FragmentTabHost;->d:Landroid/support/v4/app/t;
    ...
    iget-object v0, p0, Landroid/support/v4/app/FragmentTabHost;->d:Landroid/support/v4/app/t;
    ...
    invoke-virtual {v0, v2}, Landroid/support/v4/app/y;->d(Landroid/support/v4/app/Fragment;)Landroid/support/v4/app/y;
...
.method protected onAttachedToWindow()V
    ...
    iget-object v5, p0, Landroid/support/v4/app/FragmentTabHost;->d:Landroid/support/v4/app/t;

    iget-object v6, v0, Landroid/support/v4/app/FragmentTabHost$b;->a:Ljava/lang/String;

    invoke-virtual {v5, v6}, Landroid/support/v4/app/t;->a(Ljava/lang/String;)Landroid/support/v4/app/Fragment;
    ...
    invoke-virtual {v5}, Landroid/support/v4/app/Fragment;->A()Z
    ...
    invoke-virtual {v1, v0}, Landroid/support/v4/app/y;->d(Landroid/support/v4/app/Fragment;)Landroid/support/v4/app/y;
