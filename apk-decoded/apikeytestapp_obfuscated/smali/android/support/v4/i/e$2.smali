.class Landroid/support/v4/i/e$2;
.super Landroid/os/AsyncTask;


# annotations
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Landroid/support/v4/i/e;->a(Landroid/print/PrintAttributes;ILandroid/graphics/Bitmap;Landroid/os/ParcelFileDescriptor;Landroid/os/CancellationSignal;Landroid/print/PrintDocumentAdapter$WriteResultCallback;)V
.end annotation
...
.field final synthetic h:Landroid/support/v4/i/e;


# direct methods
.method constructor <init>(Landroid/support/v4/i/e;Landroid/os/CancellationSignal;Landroid/print/PrintAttributes;Landroid/graphics/Bitmap;Landroid/print/PrintAttributes;ILandroid/os/ParcelFileDescriptor;Landroid/print/PrintDocumentAdapter$WriteResultCallback;)V
    .locals 0

    iput-object p1, p0, Landroid/support/v4/i/e$2;->h:Landroid/support/v4/i/e;

    iput-object p2, p0, Landroid/support/v4/i/e$2;->a:Landroid/os/CancellationSignal;

    iput-object p3, p0, Landroid/support/v4/i/e$2;->b:Landroid/print/PrintAttributes;

    iput-object p4, p0, Landroid/support/v4/i/e$2;->c:Landroid/graphics/Bitmap;

    iput-object p5, p0, Landroid/support/v4/i/e$2;->d:Landroid/print/PrintAttributes;

    iput p6, p0, Landroid/support/v4/i/e$2;->e:I

    iput-object p7, p0, Landroid/support/v4/i/e$2;->f:Landroid/os/ParcelFileDescriptor;

    iput-object p8, p0, Landroid/support/v4/i/e$2;->g:Landroid/print/PrintDocumentAdapter$WriteResultCallback;
...
.method protected varargs a([Ljava/lang/Void;)Ljava/lang/Throwable;
    ...
    :try_start_0
    iget-object v1, p0, Landroid/support/v4/i/e$2;->a:Landroid/os/CancellationSignal;
    ...
    iget-object v1, p0, Landroid/support/v4/i/e$2;->h:Landroid/support/v4/i/e;

    iget-object v1, v1, Landroid/support/v4/i/e;->a:Landroid/content/Context;

    iget-object v3, p0, Landroid/support/v4/i/e$2;->b:Landroid/print/PrintAttributes;
    ...
    iget-object v3, p0, Landroid/support/v4/i/e$2;->c:Landroid/graphics/Bitmap;

    iget-object v4, p0, Landroid/support/v4/i/e$2;->b:Landroid/print/PrintAttributes;

    invoke-virtual {v4}, Landroid/print/PrintAttributes;->getColorMode()I

    move-result v4

    invoke-static {v1, v3, v4}, Landroid/support/v4/i/e;->a(Landroid/support/v4/i/e;Landroid/graphics/Bitmap;I)Landroid/graphics/Bitmap;
    ...
    iget-boolean v1, v1, Landroid/support/v4/i/e;->j:Z
    ...
    :goto_1
    iget-object v5, p0, Landroid/support/v4/i/e$2;->h:Landroid/support/v4/i/e;
    ...
    iget v8, p0, Landroid/support/v4/i/e$2;->e:I

    invoke-static {v5, v6, v7, v1, v8}, Landroid/support/v4/i/e;->a(Landroid/support/v4/i/e;IILandroid/graphics/RectF;I)Landroid/graphics/Matrix;

    move-result-object v5

    iget-object v6, p0, Landroid/support/v4/i/e$2;->h:Landroid/support/v4/i/e;

    iget-boolean v6, v6, Landroid/support/v4/i/e;->j:Z
    ...
    iget-object v1, p0, Landroid/support/v4/i/e$2;->f:Landroid/os/ParcelFileDescriptor;
    :try_end_2
    ...
    :goto_3
    :try_start_4
    iget-object v1, p0, Landroid/support/v4/i/e$2;->c:Landroid/graphics/Bitmap;
    ...
    iget-object v6, p0, Landroid/support/v4/i/e$2;->d:Landroid/print/PrintAttributes;
    ...
    iget-object v4, p0, Landroid/support/v4/i/e$2;->f:Landroid/os/ParcelFileDescriptor;
...
.method protected a(Ljava/lang/Throwable;)V
    ...
    iget-object v0, p0, Landroid/support/v4/i/e$2;->a:Landroid/os/CancellationSignal;
    ...
    iget-object v0, p0, Landroid/support/v4/i/e$2;->g:Landroid/print/PrintDocumentAdapter$WriteResultCallback;
...
.method protected synthetic doInBackground([Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Landroid/support/v4/i/e$2;->a([Ljava/lang/Void;)Ljava/lang/Throwable;
...
.method protected synthetic onPostExecute(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, Landroid/support/v4/i/e$2;->a(Ljava/lang/Throwable;)V
