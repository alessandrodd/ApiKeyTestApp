.class Landroid/support/v4/media/h$3;
.super Landroid/support/v4/media/h$h;


# annotations
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Landroid/support/v4/media/h;->a(Ljava/lang/String;Landroid/os/Bundle;Landroid/support/v4/media/h$b;Landroid/support/v4/os/ResultReceiver;)V
.end annotation
...
.method constructor <init>(Landroid/support/v4/media/h;Ljava/lang/Object;Landroid/support/v4/os/ResultReceiver;)V
    ...
    iput-object p1, p0, Landroid/support/v4/media/h$3;->b:Landroid/support/v4/media/h;

    iput-object p3, p0, Landroid/support/v4/media/h$3;->a:Landroid/support/v4/os/ResultReceiver;
...
.method bridge synthetic a(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, Landroid/support/v4/media/h$3;->a(Ljava/util/List;)V
...
.method a(Ljava/util/List;)V
    ...
    invoke-virtual {p0}, Landroid/support/v4/media/h$3;->c()I
    ...
    :cond_0
    iget-object v0, p0, Landroid/support/v4/media/h$3;->a:Landroid/support/v4/os/ResultReceiver;
