...
.method public run()V
    ...
    iget v0, v0, Landroid/support/v4/media/MediaBrowserCompat$i;->k:I
    ...
    iget-object v0, v0, Landroid/support/v4/media/MediaBrowserCompat$i;->l:Landroid/support/v4/media/MediaBrowserCompat$i$a;
    ...
    iget-object v0, v0, Landroid/support/v4/media/MediaBrowserCompat$i;->m:Landroid/support/v4/media/MediaBrowserCompat$l;
    ...
    iget-object v2, v2, Landroid/support/v4/media/MediaBrowserCompat$i;->m:Landroid/support/v4/media/MediaBrowserCompat$l;
    ...
    iget-object v0, v0, Landroid/support/v4/media/MediaBrowserCompat$i;->n:Landroid/os/Messenger;
    ...
    iget-object v2, v2, Landroid/support/v4/media/MediaBrowserCompat$i;->n:Landroid/os/Messenger;
    ...
    iget-object v0, v0, Landroid/support/v4/media/MediaBrowserCompat$i;->g:Landroid/content/ComponentName;
    ...
    iput-object v2, v0, Landroid/support/v4/media/MediaBrowserCompat$i;->l:Landroid/support/v4/media/MediaBrowserCompat$i$a;
    ...
    iget-object v2, v2, Landroid/support/v4/media/MediaBrowserCompat$i;->f:Landroid/content/Context;

    iget-object v3, p0, Landroid/support/v4/media/MediaBrowserCompat$i$1;->a:Landroid/support/v4/media/MediaBrowserCompat$i;

    iget-object v3, v3, Landroid/support/v4/media/MediaBrowserCompat$i;->l:Landroid/support/v4/media/MediaBrowserCompat$i$a;
