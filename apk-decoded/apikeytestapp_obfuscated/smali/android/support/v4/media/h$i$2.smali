.class Landroid/support/v4/media/h$i$2;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Landroid/support/v4/media/h$i;->a(Landroid/support/v4/media/h$j;)V
.end annotation
...
.method constructor <init>(Landroid/support/v4/media/h$i;Landroid/support/v4/media/h$j;)V
    ...
    iput-object p1, p0, Landroid/support/v4/media/h$i$2;->b:Landroid/support/v4/media/h$i;

    iput-object p2, p0, Landroid/support/v4/media/h$i$2;->a:Landroid/support/v4/media/h$j;
...
.method public run()V
    ...
    iget-object v0, p0, Landroid/support/v4/media/h$i$2;->a:Landroid/support/v4/media/h$j;

    invoke-interface {v0}, Landroid/support/v4/media/h$j;->a()Landroid/os/IBinder;

    move-result-object v0

    iget-object v1, p0, Landroid/support/v4/media/h$i$2;->b:Landroid/support/v4/media/h$i;
