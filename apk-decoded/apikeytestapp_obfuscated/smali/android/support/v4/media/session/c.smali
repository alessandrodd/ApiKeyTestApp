...
.method public static a(Landroid/content/Context;J)Landroid/app/PendingIntent;
    ...
    invoke-static {p0}, Landroid/support/v4/media/session/c;->a(Landroid/content/Context;)Landroid/content/ComponentName;
    ...
    :cond_0
    invoke-static {p0, v0, p1, p2}, Landroid/support/v4/media/session/c;->a(Landroid/content/Context;Landroid/content/ComponentName;J)Landroid/app/PendingIntent;
...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    invoke-static {p1, v0}, Landroid/support/v4/media/session/c;->a(Landroid/content/Context;Ljava/lang/String;)Landroid/content/ComponentName;
    ...
    invoke-static {p1, p2}, Landroid/support/v4/media/session/c;->a(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    invoke-virtual {p0}, Landroid/support/v4/media/session/c;->goAsync()Landroid/content/BroadcastReceiver$PendingResult;
    ...
    new-instance v3, Landroid/support/v4/media/session/c$a;

    invoke-direct {v3, v2, p2, v1}, Landroid/support/v4/media/session/c$a;-><init>(Landroid/content/Context;Landroid/content/Intent;Landroid/content/BroadcastReceiver$PendingResult;)V
    ...
    invoke-virtual {v3, v1}, Landroid/support/v4/media/session/c$a;->a(Landroid/support/v4/media/MediaBrowserCompat;)V
