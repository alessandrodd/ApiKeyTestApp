...
.field static final c:Landroid/support/v4/widget/DrawerLayout$b;
...
.field private x:Landroid/support/v4/widget/DrawerLayout$e;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/widget/DrawerLayout;->c:Landroid/support/v4/widget/DrawerLayout$b;
...
.method private c(Landroid/view/View;Z)V
    ...
    invoke-static {v2, v3}, Landroid/support/v4/view/r;->b(Landroid/view/View;I)V
...
.method a()Landroid/view/View;
    ...
    iget v0, v0, Landroid/support/v4/widget/DrawerLayout$f;->d:I
...
.method public a(II)V
    ...
    :goto_1
    invoke-virtual {v0}, Landroid/support/v4/widget/p;->e()V
...
.method a(IILandroid/view/View;)V
    ...
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/p;

    invoke-virtual {v2}, Landroid/support/v4/widget/p;->a()I

    move-result v2

    iget-object v3, p0, Landroid/support/v4/widget/DrawerLayout;->l:Landroid/support/v4/widget/p;

    invoke-virtual {v3}, Landroid/support/v4/widget/p;->a()I
    ...
    invoke-interface {v0, v2}, Landroid/support/v4/widget/DrawerLayout$e;->a(I)V
...
.method public a(Landroid/support/v4/widget/DrawerLayout$e;)V
    .locals 1
...
.method public a(Landroid/view/View;Z)V
    ...
    iput v3, v0, Landroid/support/v4/widget/DrawerLayout$f;->b:F

    iput v4, v0, Landroid/support/v4/widget/DrawerLayout$f;->d:I
    ...
    iget v1, v0, Landroid/support/v4/widget/DrawerLayout$f;->d:I

    or-int/lit8 v1, v1, 0x2

    iput v1, v0, Landroid/support/v4/widget/DrawerLayout$f;->d:I
    ...
    invoke-virtual {v0, p1, v2, v1}, Landroid/support/v4/widget/p;->a(Landroid/view/View;II)Z
...
.method public addView(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;)V
    ...
    invoke-static {p1, v0}, Landroid/support/v4/view/r;->b(Landroid/view/View;I)V
...
.method public b(Landroid/support/v4/widget/DrawerLayout$e;)V
    .locals 1
...
.method b(Landroid/view/View;)V
    ...
    iput v3, v0, Landroid/support/v4/widget/DrawerLayout$f;->d:I
...
.method public b(Landroid/view/View;Z)V
    ...
    iput v2, v0, Landroid/support/v4/widget/DrawerLayout$f;->b:F
...
.method c(Landroid/view/View;)V
    ...
    iput v2, v0, Landroid/support/v4/widget/DrawerLayout$f;->d:I
...
.method public computeScroll()V
    ...
    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->l:Landroid/support/v4/widget/p;
...
.method protected drawChild(Landroid/graphics/Canvas;Landroid/view/View;J)Z
    ...
    invoke-virtual {v3}, Landroid/support/v4/widget/p;->b()I
...
.method public onDraw(Landroid/graphics/Canvas;)V
    ...
    sget-object v0, Landroid/support/v4/widget/DrawerLayout;->c:Landroid/support/v4/widget/DrawerLayout$b;
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v4, p0, Landroid/support/v4/widget/DrawerLayout;->l:Landroid/support/v4/widget/p;
    ...
    iget-object v5, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/p;

    float-to-int v0, v0

    float-to-int v4, v4

    invoke-virtual {v5, v0, v4}, Landroid/support/v4/widget/p;->d(II)Landroid/view/View;
    ...
    invoke-virtual {v0, v4}, Landroid/support/v4/widget/p;->d(I)Z
...
.method protected onMeasure(II)V
    ...
    iget v6, v0, Landroid/support/v4/widget/DrawerLayout$f;->a:I

    invoke-static {v6, v8}, Landroid/support/v4/view/c;->a(II)I

    move-result v6

    invoke-static {v10}, Landroid/support/v4/view/r;->o(Landroid/view/View;)Z

    move-result v11

    if-eqz v11, :cond_8

    sget-object v11, Landroid/support/v4/widget/DrawerLayout;->c:Landroid/support/v4/widget/DrawerLayout$b;

    iget-object v12, p0, Landroid/support/v4/widget/DrawerLayout;->E:Ljava/lang/Object;

    invoke-interface {v11, v10, v12, v6}, Landroid/support/v4/widget/DrawerLayout$b;->a(Landroid/view/View;Ljava/lang/Object;I)V
    ...
    iget v6, v0, Landroid/support/v4/widget/DrawerLayout$f;->leftMargin:I

    sub-int v6, v2, v6

    iget v11, v0, Landroid/support/v4/widget/DrawerLayout$f;->rightMargin:I
    ...
    invoke-interface {v11, v0, v12, v6}, Landroid/support/v4/widget/DrawerLayout$b;->a(Landroid/view/ViewGroup$MarginLayoutParams;Ljava/lang/Object;I)V
    ...
    invoke-static {v10}, Landroid/support/v4/view/r;->k(Landroid/view/View;)F
    ...
    invoke-static {v10, v6}, Landroid/support/v4/view/r;->a(Landroid/view/View;F)V
    ...
    iget v11, v0, Landroid/support/v4/widget/DrawerLayout$f;->leftMargin:I
    ...
    iget v11, v0, Landroid/support/v4/widget/DrawerLayout$f;->width:I
    ...
    iget v12, v0, Landroid/support/v4/widget/DrawerLayout$f;->bottomMargin:I
...
.method protected onSaveInstanceState()Landroid/os/Parcelable;
    ...
    :goto_1
    iget v4, v0, Landroid/support/v4/widget/DrawerLayout$f;->d:I
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v4, v5, v6}, Landroid/support/v4/widget/p;->d(II)Landroid/view/View;
    ...
    invoke-virtual {v4}, Landroid/support/v4/widget/p;->d()I
...
.method public setDrawerListener(Landroid/support/v4/widget/DrawerLayout$e;)V
    ...
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->x:Landroid/support/v4/widget/DrawerLayout$e;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->x:Landroid/support/v4/widget/DrawerLayout$e;

    invoke-virtual {p0, v0}, Landroid/support/v4/widget/DrawerLayout;->b(Landroid/support/v4/widget/DrawerLayout$e;)V

    :cond_0
    if-eqz p1, :cond_1

    invoke-virtual {p0, p1}, Landroid/support/v4/widget/DrawerLayout;->a(Landroid/support/v4/widget/DrawerLayout$e;)V

    :cond_1
    iput-object p1, p0, Landroid/support/v4/widget/DrawerLayout;->x:Landroid/support/v4/widget/DrawerLayout$e;
