.class Landroid/support/v4/widget/aa$g;
...
.method public a(Landroid/widget/TextView;)I
    ...
    sget-boolean v0, Landroid/support/v4/widget/aa$g;->f:Z

    if-nez v0, :cond_0

    const-string v0, "mMaxMode"

    invoke-static {v0}, Landroid/support/v4/widget/aa$g;->a(Ljava/lang/String;)Ljava/lang/reflect/Field;

    move-result-object v0

    sput-object v0, Landroid/support/v4/widget/aa$g;->e:Ljava/lang/reflect/Field;

    sput-boolean v1, Landroid/support/v4/widget/aa$g;->f:Z

    :cond_0
    sget-object v0, Landroid/support/v4/widget/aa$g;->e:Ljava/lang/reflect/Field;

    if-eqz v0, :cond_2

    sget-object v0, Landroid/support/v4/widget/aa$g;->e:Ljava/lang/reflect/Field;

    invoke-static {v0, p1}, Landroid/support/v4/widget/aa$g;->a(Ljava/lang/reflect/Field;Landroid/widget/TextView;)I

    move-result v0

    if-ne v0, v1, :cond_2

    sget-boolean v0, Landroid/support/v4/widget/aa$g;->d:Z
    ...
    sput-object v0, Landroid/support/v4/widget/aa$g;->c:Ljava/lang/reflect/Field;

    sput-boolean v1, Landroid/support/v4/widget/aa$g;->d:Z

    :cond_1
    sget-object v0, Landroid/support/v4/widget/aa$g;->c:Ljava/lang/reflect/Field;
...
.method public b(Landroid/widget/TextView;)I
    ...
    sget-boolean v0, Landroid/support/v4/widget/aa$g;->j:Z
    ...
    sput-object v0, Landroid/support/v4/widget/aa$g;->i:Ljava/lang/reflect/Field;

    sput-boolean v1, Landroid/support/v4/widget/aa$g;->j:Z

    :cond_0
    sget-object v0, Landroid/support/v4/widget/aa$g;->i:Ljava/lang/reflect/Field;
    ...
    sget-boolean v0, Landroid/support/v4/widget/aa$g;->h:Z
    ...
    sput-object v0, Landroid/support/v4/widget/aa$g;->g:Ljava/lang/reflect/Field;

    sput-boolean v1, Landroid/support/v4/widget/aa$g;->h:Z

    :cond_1
    sget-object v0, Landroid/support/v4/widget/aa$g;->g:Ljava/lang/reflect/Field;
