.class public Landroid/support/v4/d/e$b;
...
.method constructor <init>(C[F)V
    ...
    iput-char p1, p0, Landroid/support/v4/d/e$b;->a:C

    iput-object p2, p0, Landroid/support/v4/d/e$b;->b:[F
...
.method constructor <init>(Landroid/support/v4/d/e$b;)V
    ...
    iget-char v0, p1, Landroid/support/v4/d/e$b;->a:C

    iput-char v0, p0, Landroid/support/v4/d/e$b;->a:C

    iget-object v0, p1, Landroid/support/v4/d/e$b;->b:[F

    const/4 v1, 0x0

    iget-object v2, p1, Landroid/support/v4/d/e$b;->b:[F

    array-length v2, v2

    invoke-static {v0, v1, v2}, Landroid/support/v4/d/e;->a([FII)[F

    move-result-object v0

    iput-object v0, p0, Landroid/support/v4/d/e$b;->b:[F
...
.method private static a(Landroid/graphics/Path;FFFFFFFZZ)V
    ...
    invoke-static/range {v2 .. v11}, Landroid/support/v4/d/e$b;->a(Landroid/graphics/Path;FFFFFFFZZ)V
    ...
    invoke-static/range {v3 .. v21}, Landroid/support/v4/d/e$b;->a(Landroid/graphics/Path;DDDDDDDDD)V
...
.method private static a(Landroid/graphics/Path;[FCC[F)V
    ...
    invoke-static/range {v3 .. v12}, Landroid/support/v4/d/e$b;->a(Landroid/graphics/Path;FFFFFFFZZ)V
...
.method public static a([Landroid/support/v4/d/e$b;Landroid/graphics/Path;)V
    .locals 5
    ...
    invoke-static {p1, v2, v1, v3, v4}, Landroid/support/v4/d/e$b;->a(Landroid/graphics/Path;[FCC[F)V

    aget-object v1, p0, v0

    iget-char v1, v1, Landroid/support/v4/d/e$b;->a:C
...
# virtual methods
.method public a(Landroid/support/v4/d/e$b;Landroid/support/v4/d/e$b;F)V
    .locals 4

    const/4 v0, 0x0

    :goto_0
    iget-object v1, p1, Landroid/support/v4/d/e$b;->b:[F

    array-length v1, v1

    if-ge v0, v1, :cond_0

    iget-object v1, p0, Landroid/support/v4/d/e$b;->b:[F
    ...
    iget-object v3, p2, Landroid/support/v4/d/e$b;->b:[F
