...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/e/b;->d:Landroid/support/v4/g/l;
...
.method public static a(Landroid/content/Context;Landroid/os/CancellationSignal;[Landroid/support/v4/e/b$b;)Landroid/graphics/Typeface;
    .locals 1

    invoke-static {p0, p2, p1}, Landroid/support/v4/e/b;->a(Landroid/content/Context;[Landroid/support/v4/e/b$b;Landroid/os/CancellationSignal;)Ljava/util/Map;

    move-result-object v0

    invoke-static {p0, p2, v0}, Landroid/support/v4/b/c;->a(Landroid/content/Context;[Landroid/support/v4/e/b$b;Ljava/util/Map;)Landroid/graphics/Typeface;
...
.method static synthetic a(Landroid/content/Context;Landroid/support/v4/e/a;)Landroid/graphics/Typeface;
    .locals 1

    invoke-static {p0, p1}, Landroid/support/v4/e/b;->b(Landroid/content/Context;Landroid/support/v4/e/a;)Landroid/graphics/Typeface;
...
.method public static a(Landroid/content/Context;Landroid/support/v4/e/a;Landroid/widget/TextView;III)Landroid/graphics/Typeface;
    ...
    invoke-direct {v3, p0, p1, v2}, Landroid/support/v4/e/b$1;-><init>(Landroid/content/Context;Landroid/support/v4/e/a;Ljava/lang/String;)V
    ...
    invoke-direct {v4, p2, p5}, Landroid/support/v4/e/b$2;-><init>(Landroid/widget/TextView;I)V
    ...
    :try_start_1
    sget-object v0, Landroid/support/v4/e/b;->d:Landroid/support/v4/g/l;

    invoke-virtual {v0, v2}, Landroid/support/v4/g/l;->containsKey(Ljava/lang/Object;)Z
    ...
    sget-object v4, Landroid/support/v4/e/b;->d:Landroid/support/v4/g/l;

    invoke-virtual {v4, v2, v0}, Landroid/support/v4/g/l;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method private static a(Landroid/content/Context;[Landroid/support/v4/e/b$b;Landroid/os/CancellationSignal;)Ljava/util/Map;
    .locals 12
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v0}, Landroid/support/v4/e/b$b;->b()I
...
.method private static b(Landroid/content/Context;Landroid/support/v4/e/a;)Landroid/graphics/Typeface;
    .locals 3
    ...
    invoke-static {p0, v0, v1}, Landroid/support/v4/e/b;->a(Landroid/content/Context;Landroid/os/CancellationSignal;[Landroid/support/v4/e/b$b;)Landroid/graphics/Typeface;
