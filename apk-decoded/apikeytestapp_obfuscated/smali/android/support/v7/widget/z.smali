...
.method protected static a(Landroid/content/Context;Landroid/support/v7/widget/m;I)Landroid/support/v7/widget/bd;
    .locals 3
...
.method private b(Z)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/widget/ac;->a(Z)V
...
.method private h()Z
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/ac;->h()Z
...
.method a()V
    ...
    iget-object v2, p0, Landroid/support/v7/widget/z;->b:Landroid/support/v7/widget/bd;

    invoke-virtual {p0, v1, v2}, Landroid/support/v7/widget/z;->a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/bd;)V

    const/4 v1, 0x1

    aget-object v1, v0, v1

    iget-object v2, p0, Landroid/support/v7/widget/z;->c:Landroid/support/v7/widget/bd;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/z;->d:Landroid/support/v7/widget/bd;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/z;->e:Landroid/support/v7/widget/bd;

    invoke-virtual {p0, v0, v1}, Landroid/support/v7/widget/z;->a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/bd;)V
...
.method a(Landroid/content/Context;I)V
    ...
    :cond_1
    invoke-direct {p0, p1, v0}, Landroid/support/v7/widget/z;->a(Landroid/content/Context;Landroid/support/v7/widget/bf;)V
...
.method final a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/bd;)V
    ...
    invoke-static {p1, p2, v0}, Landroid/support/v7/widget/m;->a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/bd;[I)V
...
.method a(Landroid/util/AttributeSet;I)V
    ...
    invoke-virtual {v3, v4, v9}, Landroid/support/v7/widget/bf;->f(II)I
    ...
    invoke-virtual {v3, v6, v2}, Landroid/support/v7/widget/bf;->f(II)I

    move-result v6

    invoke-static {v7, v0, v6}, Landroid/support/v7/widget/z;->a(Landroid/content/Context;Landroid/support/v7/widget/m;I)Landroid/support/v7/widget/bd;

    move-result-object v6

    iput-object v6, p0, Landroid/support/v7/widget/z;->b:Landroid/support/v7/widget/bd;
    ...
    iput-object v6, p0, Landroid/support/v7/widget/z;->c:Landroid/support/v7/widget/bd;
    ...
    iput-object v6, p0, Landroid/support/v7/widget/z;->d:Landroid/support/v7/widget/bd;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/z;->e:Landroid/support/v7/widget/bd;
    ...
    :goto_0
    invoke-direct {p0, v7, v9}, Landroid/support/v7/widget/z;->a(Landroid/content/Context;Landroid/support/v7/widget/bf;)V
...
.method a(ZIIII)V
    ...
    invoke-direct {p0, v0}, Landroid/support/v7/widget/z;->b(Z)V
