...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;IILandroid/content/res/Resources$Theme;)V
    ...
    invoke-static {p1, p2, v0, p3, v7}, Landroid/support/v7/widget/bf;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/bf;
    ...
    invoke-direct {v0, p1, p5}, Landroid/support/v7/e/d;-><init>(Landroid/content/Context;Landroid/content/res/Resources$Theme;)V
    ...
    invoke-static {v2, p2, v5, p3, v7}, Landroid/support/v7/widget/bf;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/bf;
    ...
    invoke-virtual {v2, v5, v6}, Landroid/support/v7/widget/bf;->e(II)I
    ...
    invoke-virtual {v2, v5}, Landroid/support/v7/widget/bf;->a(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v4, v5}, Landroid/support/v7/widget/bf;->d(I)Ljava/lang/String;

    move-result-object v5

    invoke-virtual {v0, v5}, Landroid/support/v7/widget/y$b;->a(Ljava/lang/CharSequence;)V

    invoke-virtual {v2}, Landroid/support/v7/widget/bf;->a()V
    ...
    iput-object v2, p0, Landroid/support/v7/widget/y;->d:Landroid/support/v7/widget/ak;

    :cond_2
    sget v0, Landroid/support/v7/a/a$j;->Spinner_android_entries:I

    invoke-virtual {v4, v0}, Landroid/support/v7/widget/bf;->f(I)[Ljava/lang/CharSequence;
    ...
    :cond_3
    invoke-virtual {v4}, Landroid/support/v7/widget/bf;->a()V
    ...
    invoke-virtual {v4, v0, v7}, Landroid/support/v7/widget/bf;->f(II)I

    move-result v0

    if-eqz v0, :cond_6

    new-instance v2, Landroid/support/v7/e/d;

    invoke-direct {v2, p1, v0}, Landroid/support/v7/e/d;-><init>(Landroid/content/Context;I)V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v0, p0, Landroid/support/v7/widget/y;->d:Landroid/support/v7/widget/ak;
