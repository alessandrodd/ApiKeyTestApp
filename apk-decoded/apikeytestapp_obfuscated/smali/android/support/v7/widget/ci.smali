...
.method private constructor <init>(Landroid/content/Context;Landroid/content/res/TypedArray;)V
    ...
    iput-object p1, p0, Landroid/support/v7/widget/ci;->a:Landroid/content/Context;

    iput-object p2, p0, Landroid/support/v7/widget/ci;->b:Landroid/content/res/TypedArray;

    return-void
.end method

.method public static a(Landroid/content/Context;I[I)Landroid/support/v7/widget/ci;
    .locals 2
    ...
    invoke-direct {v0, p0, v1}, Landroid/support/v7/widget/ci;-><init>(Landroid/content/Context;Landroid/content/res/TypedArray;)V

    return-object v0
.end method

.method public static a(Landroid/content/Context;Landroid/util/AttributeSet;[I)Landroid/support/v7/widget/ci;
    .locals 2
...
.method public static a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/ci;
    .locals 2
...
.method public a(IF)F
    ...
    iget-object v0, p0, Landroid/support/v7/widget/ci;->b:Landroid/content/res/TypedArray;
...
.method public a(IILandroid/widget/TextView;)Landroid/graphics/Typeface;
    ...
    :cond_1
    iget-object v1, p0, Landroid/support/v7/widget/ci;->c:Landroid/util/TypedValue;
    ...
    iput-object v1, p0, Landroid/support/v7/widget/ci;->c:Landroid/util/TypedValue;

    :cond_2
    iget-object v1, p0, Landroid/support/v7/widget/ci;->a:Landroid/content/Context;

    iget-object v2, p0, Landroid/support/v7/widget/ci;->c:Landroid/util/TypedValue;
...
.method public b(I)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/ci;->a:Landroid/content/Context;

    const/4 v3, 0x1

    invoke-virtual {v1, v2, v0, v3}, Landroid/support/v7/widget/r;->a(Landroid/content/Context;IZ)Landroid/graphics/drawable/Drawable;
...
.method public i(I)I
    ...
    :cond_0
    iget-object v0, p0, Landroid/support/v7/widget/ci;->c:Landroid/util/TypedValue;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ci;->c:Landroid/util/TypedValue;
