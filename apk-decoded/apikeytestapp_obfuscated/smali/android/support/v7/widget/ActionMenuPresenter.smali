...
.super Landroid/support/v7/h/a/c;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {p0, p1, v0, v1}, Landroid/support/v7/h/a/c;-><init>(Landroid/content/Context;II)V
...
.method static synthetic a(Landroid/support/v7/widget/ActionMenuPresenter;)Landroid/support/v7/h/a/k;
    .locals 1

    iget-object v0, p0, Landroid/support/v7/widget/ActionMenuPresenter;->c:Landroid/support/v7/h/a/k;
...
.method private a(Landroid/view/MenuItem;)Landroid/view/View;
    ...
    iget-object v0, p0, Landroid/support/v7/widget/ActionMenuPresenter;->f:Landroid/support/v7/h/a/t;
    ...
    instance-of v1, v2, Landroid/support/v7/h/a/t$a;

    if-eqz v1, :cond_2

    move-object v1, v2

    check-cast v1, Landroid/support/v7/h/a/t$a;

    invoke-interface {v1}, Landroid/support/v7/h/a/t$a;->getItemData()Landroid/support/v7/h/a/n;
...
.method static synthetic b(Landroid/support/v7/widget/ActionMenuPresenter;)Landroid/support/v7/h/a/k;
    .locals 1
...
.method static synthetic c(Landroid/support/v7/widget/ActionMenuPresenter;)Landroid/support/v7/h/a/t;
    .locals 1
...
.method static synthetic d(Landroid/support/v7/widget/ActionMenuPresenter;)Landroid/support/v7/h/a/k;
    .locals 1
...
.method static synthetic e(Landroid/support/v7/widget/ActionMenuPresenter;)Landroid/support/v7/h/a/k;
    .locals 1
...
.method static synthetic f(Landroid/support/v7/widget/ActionMenuPresenter;)Landroid/support/v7/h/a/t;
    .locals 1
...
.method public a(Landroid/view/ViewGroup;)Landroid/support/v7/h/a/t;
    ...
    invoke-super {p0, p1}, Landroid/support/v7/h/a/c;->a(Landroid/view/ViewGroup;)Landroid/support/v7/h/a/t;
    ...
    invoke-virtual {v0, p0}, Landroid/support/v7/widget/g;->setPresenter(Landroid/support/v7/widget/ActionMenuPresenter;)V

    :cond_0
    return-object v1
.end method

.method public a(Landroid/support/v7/h/a/n;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    .locals 3

    invoke-virtual {p1}, Landroid/support/v7/h/a/n;->getActionView()Landroid/view/View;
    ...
    :cond_0
    invoke-super {p0, p1, p2, p3}, Landroid/support/v7/h/a/c;->a(Landroid/support/v7/h/a/n;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;

    move-result-object v0

    :cond_1
    invoke-virtual {p1}, Landroid/support/v7/h/a/n;->isActionViewExpanded()Z
    ...
    check-cast p3, Landroid/support/v7/widget/g;

    invoke-virtual {v0}, Landroid/view/View;->getLayoutParams()Landroid/view/ViewGroup$LayoutParams;

    move-result-object v1

    invoke-virtual {p3, v1}, Landroid/support/v7/widget/g;->checkLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Z

    move-result v2

    if-nez v2, :cond_2

    invoke-virtual {p3, v1}, Landroid/support/v7/widget/g;->a(Landroid/view/ViewGroup$LayoutParams;)Landroid/support/v7/widget/g$c;
...
.method public a(Landroid/content/Context;Landroid/support/v7/h/a/k;)V
    ...
    invoke-super {p0, p1, p2}, Landroid/support/v7/h/a/c;->a(Landroid/content/Context;Landroid/support/v7/h/a/k;)V
    ...
    invoke-virtual {v0}, Landroid/support/v7/h/a;->b()Z
    ...
    invoke-virtual {v0}, Landroid/support/v7/h/a;->c()I
    ...
    invoke-virtual {v0}, Landroid/support/v7/h/a;->a()I
...
.method public a(Landroid/os/Parcelable;)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/h/a/k;->findItem(I)Landroid/view/MenuItem;
    ...
    invoke-virtual {p0, v0}, Landroid/support/v7/widget/ActionMenuPresenter;->a(Landroid/support/v7/h/a/y;)Z
...
.method public a(Landroid/support/v7/h/a/k;Z)V
    ...
    invoke-super {p0, p1, p2}, Landroid/support/v7/h/a/c;->a(Landroid/support/v7/h/a/k;Z)V

    return-void
.end method

.method public a(Landroid/support/v7/h/a/n;Landroid/support/v7/h/a/t$a;)V
    .locals 1

    const/4 v0, 0x0

    invoke-interface {p2, p1, v0}, Landroid/support/v7/h/a/t$a;->a(Landroid/support/v7/h/a/n;I)V

    iget-object v0, p0, Landroid/support/v7/widget/ActionMenuPresenter;->f:Landroid/support/v7/h/a/t;

    check-cast v0, Landroid/support/v7/widget/g;

    check-cast p2, Landroid/support/v7/h/a/b;

    invoke-virtual {p2, v0}, Landroid/support/v7/h/a/b;->setItemInvoker(Landroid/support/v7/h/a/k$b;)V
    ...
    invoke-virtual {p2, v0}, Landroid/support/v7/h/a/b;->setPopupCallback(Landroid/support/v7/h/a/b$b;)V

    return-void
.end method

.method public a(Landroid/support/v7/widget/g;)V
    .locals 1

    iput-object p1, p0, Landroid/support/v7/widget/ActionMenuPresenter;->f:Landroid/support/v7/h/a/t;

    iget-object v0, p0, Landroid/support/v7/widget/ActionMenuPresenter;->c:Landroid/support/v7/h/a/k;

    invoke-virtual {p1, v0}, Landroid/support/v7/widget/g;->a(Landroid/support/v7/h/a/k;)V
...
.method public a(Z)V
    ...
    invoke-super {p0, p1}, Landroid/support/v7/h/a/c;->a(Z)V
    ...
    invoke-virtual {v0}, Landroid/support/v7/h/a/k;->l()Ljava/util/ArrayList;
    ...
    invoke-virtual {v0}, Landroid/support/v7/h/a/n;->a()Landroid/support/v4/view/b;
    ...
    invoke-virtual {v0}, Landroid/support/v7/h/a/n;->isActionViewExpanded()Z
    ...
    iget-object v1, p0, Landroid/support/v7/widget/ActionMenuPresenter;->f:Landroid/support/v7/h/a/t;
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/g;->c()Landroid/support/v7/widget/g$c;

    move-result-object v2

    invoke-virtual {v0, v1, v2}, Landroid/support/v7/widget/g;->addView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/g;->setOverflowReserved(Z)V
...
.method public a()Z
    ...
    iget-object v2, v0, Landroid/support/v7/widget/ActionMenuPresenter;->c:Landroid/support/v7/h/a/k;
    ...
    invoke-virtual {v2}, Landroid/support/v7/h/a/k;->j()Ljava/util/ArrayList;
    ...
    iget-object v2, v0, Landroid/support/v7/widget/ActionMenuPresenter;->f:Landroid/support/v7/h/a/t;
    ...
    check-cast v3, Landroid/support/v7/h/a/n;

    invoke-virtual {v3}, Landroid/support/v7/h/a/n;->m()Z
    ...
    invoke-virtual {v3}, Landroid/support/v7/h/a/n;->isActionViewExpanded()Z
    ...
    :cond_1
    invoke-virtual {v3}, Landroid/support/v7/h/a/n;->l()Z
    ...
    invoke-virtual {v0, v3, v8, v2}, Landroid/support/v7/widget/ActionMenuPresenter;->a(Landroid/support/v7/h/a/n;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    invoke-static {v8, v7, v4, v15, v10}, Landroid/support/v7/widget/g;->a(Landroid/view/View;IIII)I
    ...
    :goto_7
    invoke-virtual {v3}, Landroid/support/v7/h/a/n;->getGroupId()I
    ...
    invoke-virtual {v3, v9}, Landroid/support/v7/h/a/n;->d(Z)V
    ...
    invoke-virtual {v0, v3, v10, v2}, Landroid/support/v7/widget/ActionMenuPresenter;->a(Landroid/support/v7/h/a/n;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    invoke-static {v13, v7, v4, v15, v10}, Landroid/support/v7/widget/g;->a(Landroid/view/View;IIII)I
    ...
    :cond_e
    invoke-virtual {v3, v13}, Landroid/support/v7/h/a/n;->d(Z)V
    ...
    check-cast v4, Landroid/support/v7/h/a/n;

    invoke-virtual {v4}, Landroid/support/v7/h/a/n;->getGroupId()I
    ...
    invoke-virtual {v4}, Landroid/support/v7/h/a/n;->k()Z
    ...
    invoke-virtual {v4, v0}, Landroid/support/v7/h/a/n;->d(Z)V
    ...
    invoke-virtual {v3, v8}, Landroid/support/v7/h/a/n;->d(Z)V
...
.method public a(ILandroid/support/v7/h/a/n;)Z
    .locals 1

    invoke-virtual {p2}, Landroid/support/v7/h/a/n;->k()Z
...
.method public a(Landroid/support/v7/h/a/y;)Z
    ...
    :goto_1
    invoke-virtual {v0}, Landroid/support/v7/h/a/y;->t()Landroid/view/Menu;

    move-result-object v3

    iget-object v4, p0, Landroid/support/v7/widget/ActionMenuPresenter;->c:Landroid/support/v7/h/a/k;
    ...
    invoke-virtual {p1}, Landroid/support/v7/h/a/y;->getItem()Landroid/view/MenuItem;
    ...
    invoke-virtual {p1}, Landroid/support/v7/h/a/y;->size()I
    ...
    invoke-virtual {p1, v0}, Landroid/support/v7/h/a/y;->getItem(I)Landroid/view/MenuItem;
    ...
    invoke-direct {v2, p0, v4, p1, v3}, Landroid/support/v7/widget/ActionMenuPresenter$a;-><init>(Landroid/support/v7/widget/ActionMenuPresenter;Landroid/content/Context;Landroid/support/v7/h/a/y;Landroid/view/View;)V
    ...
    invoke-super {p0, p1}, Landroid/support/v7/h/a/c;->a(Landroid/support/v7/h/a/y;)Z
...
.method public a(Landroid/view/ViewGroup;I)Z
    ...
    :cond_0
    invoke-super {p0, p1, p2}, Landroid/support/v7/h/a/c;->a(Landroid/view/ViewGroup;I)Z
...
.method public b(Z)V
    ...
    invoke-super {p0, v0}, Landroid/support/v7/h/a/c;->a(Landroid/support/v7/h/a/y;)Z
...
.method public f()Z
    ...
    iget-object v3, p0, Landroid/support/v7/widget/ActionMenuPresenter;->c:Landroid/support/v7/h/a/k;

    iget-object v4, p0, Landroid/support/v7/widget/ActionMenuPresenter;->g:Landroid/support/v7/widget/ActionMenuPresenter$d;

    move-object v1, p0

    invoke-direct/range {v0 .. v5}, Landroid/support/v7/widget/ActionMenuPresenter$e;-><init>(Landroid/support/v7/widget/ActionMenuPresenter;Landroid/content/Context;Landroid/support/v7/h/a/k;Landroid/view/View;Z)V
