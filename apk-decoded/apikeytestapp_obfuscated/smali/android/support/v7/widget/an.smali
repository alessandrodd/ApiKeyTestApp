...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput v4, p0, Landroid/support/v7/widget/an;->b:I

    iput v3, p0, Landroid/support/v7/widget/an;->c:I
    ...
    invoke-static {p1, p2, v0, p3, v3}, Landroid/support/v7/widget/bf;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/bf;

    move-result-object v0

    sget v1, Landroid/support/v7/a/a$j;->LinearLayoutCompat_android_orientation:I

    invoke-virtual {v0, v1, v4}, Landroid/support/v7/widget/bf;->a(II)I
    ...
    invoke-virtual {v0, v1, v2}, Landroid/support/v7/widget/bf;->a(IF)F
    ...
    invoke-virtual {v0, v1, v3}, Landroid/support/v7/widget/bf;->a(IZ)Z
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/bf;->a(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v0, v1, v3}, Landroid/support/v7/widget/bf;->a(II)I
    ...
    invoke-virtual {v0, v1, v3}, Landroid/support/v7/widget/bf;->d(II)I
...
.method private c(II)V
    ...
    invoke-virtual {p0, v7}, Landroid/support/v7/widget/an;->b(I)Landroid/view/View;
...
.method private d(II)V
    ...
    iget v0, v6, Landroid/support/v7/widget/an$a;->height:I

    const/4 v2, -0x1

    if-ne v0, v2, :cond_0

    iget v8, v6, Landroid/support/v7/widget/an$a;->width:I

    invoke-virtual {v1}, Landroid/view/View;->getMeasuredWidth()I

    move-result v0

    iput v0, v6, Landroid/support/v7/widget/an$a;->width:I
    ...
    iput v8, v6, Landroid/support/v7/widget/an$a;->width:I
...
.method a(II)V
    ...
    invoke-virtual {v0, v5}, Landroid/support/v7/widget/an;->b(I)Landroid/view/View;
    ...
    invoke-virtual {v0, v5}, Landroid/support/v7/widget/an;->d(I)I
    ...
    invoke-virtual {v0, v4, v5}, Landroid/support/v7/widget/an;->a(Landroid/view/View;I)I
    ...
    invoke-virtual {v0, v5}, Landroid/support/v7/widget/an;->c(I)Z
    ...
    iget v7, v0, Landroid/support/v7/widget/an;->m:I
    ...
    iget v3, v10, Landroid/support/v7/widget/an$a;->g:F
    ...
    iget v3, v10, Landroid/support/v7/widget/an$a;->height:I
    ...
    iget v6, v10, Landroid/support/v7/widget/an$a;->topMargin:I

    add-int/2addr v6, v3

    iget v7, v10, Landroid/support/v7/widget/an$a;->bottomMargin:I
    ...
    iget v6, v10, Landroid/support/v7/widget/an$a;->g:F
    ...
    iput v6, v10, Landroid/support/v7/widget/an$a;->height:I
    ...
    iget v9, v0, Landroid/support/v7/widget/an;->f:I
    ...
    invoke-virtual/range {v3 .. v9}, Landroid/support/v7/widget/an;->a(Landroid/view/View;IIIII)V
    ...
    iget v8, v10, Landroid/support/v7/widget/an$a;->topMargin:I

    add-int/2addr v7, v8

    iget v8, v10, Landroid/support/v7/widget/an$a;->bottomMargin:I

    add-int/2addr v7, v8

    move-object/from16 v0, p0

    invoke-virtual {v0, v4}, Landroid/support/v7/widget/an;->b(Landroid/view/View;)I
    ...
    iput v6, v0, Landroid/support/v7/widget/an;->f:I
    ...
    iget v6, v10, Landroid/support/v7/widget/an$a;->width:I
    ...
    :goto_4
    iget v7, v10, Landroid/support/v7/widget/an$a;->leftMargin:I

    iget v8, v10, Landroid/support/v7/widget/an$a;->rightMargin:I
    ...
    iget v7, v10, Landroid/support/v7/widget/an$a;->width:I
    ...
    :goto_5
    iget v10, v10, Landroid/support/v7/widget/an$a;->g:F
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/an;->c(I)Z
    ...
    invoke-virtual {v0, v4}, Landroid/support/v7/widget/an;->b(I)Landroid/view/View;
    ...
    invoke-virtual {v0, v4}, Landroid/support/v7/widget/an;->d(I)I
    ...
    invoke-virtual {v0, v5, v4}, Landroid/support/v7/widget/an;->a(Landroid/view/View;I)I
    ...
    iget v7, v0, Landroid/support/v7/widget/an;->f:I

    add-int v8, v7, v14

    iget v9, v3, Landroid/support/v7/widget/an$a;->topMargin:I
    ...
    invoke-virtual {v0, v5}, Landroid/support/v7/widget/an;->b(Landroid/view/View;)I
    ...
    iget v6, v0, Landroid/support/v7/widget/an;->g:F
    ...
    invoke-virtual {v0, v14}, Landroid/support/v7/widget/an;->b(I)Landroid/view/View;
    ...
    iget v13, v3, Landroid/support/v7/widget/an$a;->leftMargin:I

    add-int/2addr v8, v13

    iget v13, v3, Landroid/support/v7/widget/an$a;->rightMargin:I

    add-int/2addr v8, v13

    iget v13, v3, Landroid/support/v7/widget/an$a;->width:I

    move/from16 v0, p1

    invoke-static {v0, v8, v13}, Landroid/support/v7/widget/an;->getChildMeasureSpec(III)I

    move-result v8

    iget v13, v3, Landroid/support/v7/widget/an$a;->height:I
    ...
    :goto_e
    iget v7, v3, Landroid/support/v7/widget/an$a;->leftMargin:I

    iget v8, v3, Landroid/support/v7/widget/an$a;->rightMargin:I
    ...
    iget v7, v3, Landroid/support/v7/widget/an$a;->width:I
    ...
    invoke-virtual {v0, v15}, Landroid/support/v7/widget/an;->b(Landroid/view/View;)I
    ...
    invoke-direct {v0, v1, v2}, Landroid/support/v7/widget/an;->c(II)V
...
.method a(IIII)V
    ...
    invoke-virtual {p0, v8}, Landroid/support/v7/widget/an;->b(I)Landroid/view/View;

    move-result-object v1

    if-nez v1, :cond_0

    invoke-virtual {p0, v8}, Landroid/support/v7/widget/an;->d(I)I
    ...
    iget v0, v6, Landroid/support/v7/widget/an$a;->h:I
    ...
    iget v0, v6, Landroid/support/v7/widget/an$a;->leftMargin:I

    add-int v2, v9, v0

    :goto_3
    invoke-virtual {p0, v8}, Landroid/support/v7/widget/an;->c(I)Z
    ...
    :goto_4
    iget v3, v6, Landroid/support/v7/widget/an$a;->topMargin:I

    add-int v13, v0, v3

    invoke-virtual {p0, v1}, Landroid/support/v7/widget/an;->a(Landroid/view/View;)I
    ...
    iget v0, v6, Landroid/support/v7/widget/an$a;->bottomMargin:I

    add-int/2addr v0, v5

    invoke-virtual {p0, v1}, Landroid/support/v7/widget/an;->b(Landroid/view/View;)I
    ...
    invoke-virtual {p0, v1, v8}, Landroid/support/v7/widget/an;->a(Landroid/view/View;I)I
    ...
    iget v2, v6, Landroid/support/v7/widget/an$a;->leftMargin:I

    add-int/2addr v0, v2

    iget v2, v6, Landroid/support/v7/widget/an$a;->rightMargin:I
...
.method b(II)V
    ...
    iget-object v3, v0, Landroid/support/v7/widget/an;->i:[I

    if-eqz v3, :cond_0

    move-object/from16 v0, p0

    iget-object v3, v0, Landroid/support/v7/widget/an;->j:[I
    ...
    iput-object v3, v0, Landroid/support/v7/widget/an;->i:[I
    ...
    iput-object v3, v0, Landroid/support/v7/widget/an;->j:[I
    ...
    iget v3, v10, Landroid/support/v7/widget/an$a;->width:I
    ...
    iget v6, v10, Landroid/support/v7/widget/an$a;->leftMargin:I

    iget v7, v10, Landroid/support/v7/widget/an$a;->rightMargin:I
    ...
    :goto_5
    iget v7, v10, Landroid/support/v7/widget/an$a;->topMargin:I
    ...
    invoke-static {v0, v7}, Landroid/support/v7/widget/bo;->a(II)I
    ...
    iget v7, v10, Landroid/support/v7/widget/an$a;->h:I

    if-gez v7, :cond_f

    move-object/from16 v0, p0

    iget v7, v0, Landroid/support/v7/widget/an;->e:I
    ...
    iget v7, v10, Landroid/support/v7/widget/an$a;->height:I
    ...
    iput v6, v10, Landroid/support/v7/widget/an$a;->width:I
    ...
    iget v8, v10, Landroid/support/v7/widget/an$a;->leftMargin:I
    ...
    iget v4, v0, Landroid/support/v7/widget/an;->l:I
    ...
    invoke-virtual {v0, v7, v4}, Landroid/support/v7/widget/an;->a(Landroid/view/View;I)I
    ...
    invoke-virtual {v0, v7}, Landroid/support/v7/widget/an;->b(Landroid/view/View;)I
    ...
    iget v10, v3, Landroid/support/v7/widget/an$a;->leftMargin:I
    ...
    invoke-virtual {v0, v15}, Landroid/support/v7/widget/an;->b(I)Landroid/view/View;
    ...
    iget v13, v3, Landroid/support/v7/widget/an$a;->bottomMargin:I
    ...
    invoke-static {v0, v6, v13}, Landroid/support/v7/widget/an;->getChildMeasureSpec(III)I
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/an;->b(Landroid/view/View;)I
    ...
    iget v4, v3, Landroid/support/v7/widget/an$a;->height:I
    ...
    :goto_15
    iget v5, v3, Landroid/support/v7/widget/an$a;->topMargin:I

    iget v6, v3, Landroid/support/v7/widget/an$a;->bottomMargin:I
    ...
    iget v10, v3, Landroid/support/v7/widget/an$a;->h:I
    ...
    :cond_28
    iget v3, v3, Landroid/support/v7/widget/an$a;->h:I
    ...
    invoke-virtual {v0, v4, v3}, Landroid/support/v7/widget/an;->setMeasuredDimension(II)V
    ...
    invoke-direct {v0, v1, v2}, Landroid/support/v7/widget/an;->d(II)V
...
.method b(IIII)V
    ...
    invoke-static {v2, v3}, Landroid/support/v4/view/c;->a(II)I
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/an;->b(I)Landroid/view/View;
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/an;->d(I)I
    ...
    :goto_4
    iget v4, v8, Landroid/support/v7/widget/an$a;->h:I
    ...
    iget v2, v0, Landroid/support/v7/widget/an;->l:I
    ...
    invoke-virtual {v0, v3}, Landroid/support/v7/widget/an;->a(Landroid/view/View;)I
    ...
    iget v2, v8, Landroid/support/v7/widget/an$a;->rightMargin:I

    add-int/2addr v2, v6

    move-object/from16 v0, p0

    invoke-virtual {v0, v3}, Landroid/support/v7/widget/an;->b(Landroid/view/View;)I
    ...
    invoke-virtual {v0, v3, v1}, Landroid/support/v7/widget/an;->a(Landroid/view/View;I)I
    ...
    :sswitch_2
    iget v4, v8, Landroid/support/v7/widget/an$a;->topMargin:I
    ...
    iget v4, v8, Landroid/support/v7/widget/an$a;->bottomMargin:I
    ...
    iget v5, v8, Landroid/support/v7/widget/an$a;->bottomMargin:I
