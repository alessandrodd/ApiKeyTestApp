...
.method public a(IILandroid/view/animation/Interpolator;)V
    ...
    sget-object p3, Landroid/support/v7/widget/RecyclerView;->F:Landroid/view/animation/Interpolator;
...
.method public run()V
    ...
    iget-object v2, v2, Landroid/support/v7/widget/RecyclerView;->l:Landroid/support/v7/widget/RecyclerView$g;
    ...
    iget-object v15, v2, Landroid/support/v7/widget/RecyclerView$g;->t:Landroid/support/v7/widget/RecyclerView$q;
    ...
    invoke-virtual {v2, v10, v3, v4}, Landroid/support/v7/widget/RecyclerView$g;->a(ILandroid/support/v7/widget/RecyclerView$n;Landroid/support/v7/widget/RecyclerView$r;)I
    ...
    iget-object v6, v6, Landroid/support/v7/widget/RecyclerView;->z:Landroid/support/v7/widget/RecyclerView$r;

    invoke-virtual {v2, v9, v3, v6}, Landroid/support/v7/widget/RecyclerView$g;->b(ILandroid/support/v7/widget/RecyclerView$n;Landroid/support/v7/widget/RecyclerView$r;)I
    ...
    invoke-virtual {v6}, Landroid/support/v7/widget/RecyclerView;->w()V

    move-object/from16 v0, p0

    iget-object v6, v0, Landroid/support/v7/widget/RecyclerView$t;->b:Landroid/support/v7/widget/RecyclerView;

    invoke-virtual {v6}, Landroid/support/v7/widget/RecyclerView;->l()V
    ...
    iget-object v2, v2, Landroid/support/v7/widget/RecyclerView;->n:Ljava/util/ArrayList;
    ...
    invoke-virtual {v2, v3, v4}, Landroid/support/v7/widget/RecyclerView;->g(II)V
    ...
    invoke-virtual {v2}, Landroid/support/v7/widget/RecyclerView$g;->e()Z
    ...
    invoke-virtual {v2}, Landroid/support/v7/widget/RecyclerView$g;->d()Z
    ...
    iget-object v2, v2, Landroid/support/v7/widget/RecyclerView;->y:Landroid/support/v7/widget/al$a;
    ...
    iget-object v2, v2, Landroid/support/v7/widget/RecyclerView;->x:Landroid/support/v7/widget/al;
