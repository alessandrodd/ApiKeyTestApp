...
.method a(Landroid/support/v7/widget/RecyclerView;Z)V
    ...
    :cond_0
    iget-object v0, p1, Landroid/support/v7/widget/RecyclerView;->l:Landroid/support/v7/widget/RecyclerView$g;

    iget-object v1, p1, Landroid/support/v7/widget/RecyclerView;->k:Landroid/support/v7/widget/RecyclerView$a;

    if-eqz v1, :cond_2

    if-eqz v0, :cond_2

    invoke-virtual {v0}, Landroid/support/v7/widget/RecyclerView$g;->o()Z
    ...
    iget v2, v0, Landroid/support/v7/widget/RecyclerView$g;->x:I

    if-le v1, v2, :cond_2

    iget v1, p0, Landroid/support/v7/widget/al$a;->d:I

    iput v1, v0, Landroid/support/v7/widget/RecyclerView$g;->x:I

    iput-boolean p2, v0, Landroid/support/v7/widget/RecyclerView$g;->y:Z
    ...
    iget-object v3, p1, Landroid/support/v7/widget/RecyclerView;->z:Landroid/support/v7/widget/RecyclerView$r;

    invoke-virtual {v0, v1, v2, v3, p0}, Landroid/support/v7/widget/RecyclerView$g;->a(IILandroid/support/v7/widget/RecyclerView$r;Landroid/support/v7/widget/RecyclerView$g$a;)V
