...
.method private a(Ljava/util/List;II)V
    ...
    invoke-virtual/range {v0 .. v5}, Landroid/support/v7/widget/as;->a(Ljava/util/List;ILandroid/support/v7/widget/f$b;ILandroid/support/v7/widget/f$b;)V
    ...
    invoke-direct/range {v0 .. v5}, Landroid/support/v7/widget/as;->c(Ljava/util/List;ILandroid/support/v7/widget/f$b;ILandroid/support/v7/widget/f$b;)V
    ...
    invoke-virtual/range {v0 .. v5}, Landroid/support/v7/widget/as;->b(Ljava/util/List;ILandroid/support/v7/widget/f$b;ILandroid/support/v7/widget/f$b;)V
...
.method a(Ljava/util/List;ILandroid/support/v7/widget/f$b;ILandroid/support/v7/widget/f$b;)V
    ...
    invoke-interface {v0, p3}, Landroid/support/v7/widget/as$a;->a(Landroid/support/v7/widget/f$b;)V
    ...
    invoke-interface {v0, p5}, Landroid/support/v7/widget/as$a;->a(Landroid/support/v7/widget/f$b;)V
    ...
    invoke-interface {v4, v7, v5, v1, v3}, Landroid/support/v7/widget/as$a;->a(IIILjava/lang/Object;)Landroid/support/v7/widget/f$b;
...
.method b(Ljava/util/List;ILandroid/support/v7/widget/f$b;ILandroid/support/v7/widget/f$b;)V
    ...
    invoke-interface {v0, v5, v2, v3, v4}, Landroid/support/v7/widget/as$a;->a(IIILjava/lang/Object;)Landroid/support/v7/widget/f$b;
    ...
    invoke-interface {v1, v5, v3, v2, v4}, Landroid/support/v7/widget/as$a;->a(IIILjava/lang/Object;)Landroid/support/v7/widget/f$b;
    ...
    invoke-interface {v2, p5}, Landroid/support/v7/widget/as$a;->a(Landroid/support/v7/widget/f$b;)V
