...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v7/widget/ab;->b:Landroid/graphics/RectF;
...
.method constructor <init>(Landroid/widget/TextView;)V
    ...
    iput v1, p0, Landroid/support/v7/widget/ab;->g:I

    iput-boolean v1, p0, Landroid/support/v7/widget/ab;->h:Z

    iput v0, p0, Landroid/support/v7/widget/ab;->i:F

    iput v0, p0, Landroid/support/v7/widget/ab;->j:F

    iput v0, p0, Landroid/support/v7/widget/ab;->k:F

    new-array v0, v1, [I

    iput-object v0, p0, Landroid/support/v7/widget/ab;->l:[I

    iput-boolean v1, p0, Landroid/support/v7/widget/ab;->m:Z

    new-instance v0, Ljava/util/Hashtable;

    invoke-direct {v0}, Ljava/util/Hashtable;-><init>()V

    iput-object v0, p0, Landroid/support/v7/widget/ab;->o:Ljava/util/Hashtable;

    iput-object p1, p0, Landroid/support/v7/widget/ab;->p:Landroid/widget/TextView;

    iget-object v0, p0, Landroid/support/v7/widget/ab;->p:Landroid/widget/TextView;

    invoke-virtual {v0}, Landroid/widget/TextView;->getContext()Landroid/content/Context;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v7/widget/ab;->q:Landroid/content/Context;
...
.method private a(Landroid/graphics/RectF;)I
    ...
    iget-object v0, p0, Landroid/support/v7/widget/ab;->l:[I
    ...
    iget-object v3, p0, Landroid/support/v7/widget/ab;->l:[I
...
.method private a(Ljava/lang/CharSequence;Landroid/text/Layout$Alignment;I)Landroid/text/StaticLayout;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/ab;->n:Landroid/text/TextPaint;
    ...
    :cond_0
    iget-object v3, p0, Landroid/support/v7/widget/ab;->p:Landroid/widget/TextView;
...
.method private a(Ljava/lang/CharSequence;Landroid/text/Layout$Alignment;II)Landroid/text/StaticLayout;
    ...
    iget-object v3, p0, Landroid/support/v7/widget/ab;->n:Landroid/text/TextPaint;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/ab;->p:Landroid/widget/TextView;
...
.method private a(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :try_start_0
    iget-object v0, p0, Landroid/support/v7/widget/ab;->o:Ljava/util/Hashtable;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/ab;->o:Ljava/util/Hashtable;
...
.method private a(F)V
    ...
    iget-object v1, p0, Landroid/support/v7/widget/ab;->o:Ljava/util/Hashtable;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/ab;->p:Landroid/widget/TextView;
...
.method private a(FFF)V
    ...
    iput p1, p0, Landroid/support/v7/widget/ab;->j:F

    iput p2, p0, Landroid/support/v7/widget/ab;->k:F

    iput p3, p0, Landroid/support/v7/widget/ab;->i:F

    const/4 v0, 0x0

    iput-boolean v0, p0, Landroid/support/v7/widget/ab;->m:Z
...
.method private a(ILandroid/graphics/RectF;)Z
    ...
    invoke-direct {p0, v0, v3, v6}, Landroid/support/v7/widget/ab;->a(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :goto_1
    iget-object v0, p0, Landroid/support/v7/widget/ab;->n:Landroid/text/TextPaint;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ab;->n:Landroid/text/TextPaint;

    :goto_2
    iget-object v0, p0, Landroid/support/v7/widget/ab;->n:Landroid/text/TextPaint;

    iget-object v6, p0, Landroid/support/v7/widget/ab;->p:Landroid/widget/TextView;
    ...
    invoke-direct {p0, v0, v6, v7}, Landroid/support/v7/widget/ab;->a(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {p0, v5, v0, v3, v1}, Landroid/support/v7/widget/ab;->a(Ljava/lang/CharSequence;Landroid/text/Layout$Alignment;II)Landroid/text/StaticLayout;
    ...
    :cond_3
    invoke-direct {p0, v5, v0, v3}, Landroid/support/v7/widget/ab;->a(Ljava/lang/CharSequence;Landroid/text/Layout$Alignment;I)Landroid/text/StaticLayout;
...
.method private j()V
    ...
    invoke-direct {p0}, Landroid/support/v7/widget/ab;->l()Z
    ...
    :cond_0
    iget v0, p0, Landroid/support/v7/widget/ab;->k:F

    iget v1, p0, Landroid/support/v7/widget/ab;->j:F

    sub-float/2addr v0, v1

    iget v1, p0, Landroid/support/v7/widget/ab;->i:F
    ...
    iget v1, p0, Landroid/support/v7/widget/ab;->k:F

    iget v2, p0, Landroid/support/v7/widget/ab;->j:F

    sub-float/2addr v1, v2

    iget v2, p0, Landroid/support/v7/widget/ab;->i:F
    ...
    iget v4, p0, Landroid/support/v7/widget/ab;->i:F
    ...
    :cond_2
    invoke-direct {p0, v3}, Landroid/support/v7/widget/ab;->a([I)[I
    ...
    :cond_3
    iput-boolean v5, p0, Landroid/support/v7/widget/ab;->h:Z
...
.method a(I)V
    ...
    :pswitch_0
    invoke-direct {p0}, Landroid/support/v7/widget/ab;->k()V
    ...
    :pswitch_1
    iget-object v0, p0, Landroid/support/v7/widget/ab;->q:Landroid/content/Context;
...
.method a(Landroid/util/AttributeSet;I)V
    ...
    iget-object v4, p0, Landroid/support/v7/widget/ab;->q:Landroid/content/Context;
    ...
    :cond_7
    iput v7, p0, Landroid/support/v7/widget/ab;->g:I
...
.method a([II)V
    ...
    :cond_1
    iget-object v3, p0, Landroid/support/v7/widget/ab;->q:Landroid/content/Context;
...
.method b()I
    ...
    iget v0, p0, Landroid/support/v7/widget/ab;->i:F
...
.method c()I
    ...
    iget v0, p0, Landroid/support/v7/widget/ab;->j:F
...
.method f()V
    ...
    sget-object v2, Landroid/support/v7/widget/ab;->b:Landroid/graphics/RectF;

    monitor-enter v2

    :try_start_0
    sget-object v3, Landroid/support/v7/widget/ab;->b:Landroid/graphics/RectF;
    ...
    sget-object v1, Landroid/support/v7/widget/ab;->b:Landroid/graphics/RectF;

    int-to-float v0, v0

    iput v0, v1, Landroid/graphics/RectF;->bottom:F

    sget-object v0, Landroid/support/v7/widget/ab;->b:Landroid/graphics/RectF;
