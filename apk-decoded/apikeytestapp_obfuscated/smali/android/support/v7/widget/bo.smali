...
.method public constructor <init>()V
    ...
    invoke-direct {v0, p0}, Landroid/support/v7/widget/bo$1;-><init>(Landroid/support/v7/widget/bo;)V

    iput-object v0, p0, Landroid/support/v7/widget/bo;->d:Landroid/support/v7/widget/RecyclerView$m;
...
.method private b()V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/bo;->b:Landroid/support/v7/widget/RecyclerView;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/bo;->d:Landroid/support/v7/widget/RecyclerView$m;
...
.method private b(Landroid/support/v7/widget/RecyclerView$h;II)Z
    ...
    :cond_1
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/bo;->b(Landroid/support/v7/widget/RecyclerView$h;)Landroid/support/v7/widget/au;

    move-result-object v1

    if-eqz v1, :cond_0

    invoke-virtual {p0, p1, p2, p3}, Landroid/support/v7/widget/bo;->a(Landroid/support/v7/widget/RecyclerView$h;II)I
...
.method a()V
    ...
    invoke-virtual {p0, v0}, Landroid/support/v7/widget/bo;->a(Landroid/support/v7/widget/RecyclerView$h;)Landroid/view/View;

    move-result-object v1

    if-eqz v1, :cond_0

    invoke-virtual {p0, v0, v1}, Landroid/support/v7/widget/bo;->a(Landroid/support/v7/widget/RecyclerView$h;Landroid/view/View;)[I
...
.method public a(Landroid/support/v7/widget/RecyclerView;)V
    ...
    invoke-direct {p0}, Landroid/support/v7/widget/bo;->c()V

    :cond_2
    iput-object p1, p0, Landroid/support/v7/widget/bo;->b:Landroid/support/v7/widget/RecyclerView;

    iget-object v0, p0, Landroid/support/v7/widget/bo;->b:Landroid/support/v7/widget/RecyclerView;

    if-eqz v0, :cond_0

    invoke-direct {p0}, Landroid/support/v7/widget/bo;->b()V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/bo;->c:Landroid/widget/Scroller;
...
.method public a(II)Z
    ...
    :cond_1
    iget-object v2, p0, Landroid/support/v7/widget/bo;->b:Landroid/support/v7/widget/RecyclerView;
    ...
    :cond_2
    invoke-direct {p0, v1, p1, p2}, Landroid/support/v7/widget/bo;->b(Landroid/support/v7/widget/RecyclerView$h;II)Z
...
.method protected b(Landroid/support/v7/widget/RecyclerView$h;)Landroid/support/v7/widget/au;
    ...
    :cond_0
    new-instance v0, Landroid/support/v7/widget/bo$2;
    ...
    invoke-direct {v0, p0, v1}, Landroid/support/v7/widget/bo$2;-><init>(Landroid/support/v7/widget/bo;Landroid/content/Context;)V
...
.method public b(II)[I
    ...
    iget-object v0, p0, Landroid/support/v7/widget/bo;->c:Landroid/widget/Scroller;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/bo;->c:Landroid/widget/Scroller;
