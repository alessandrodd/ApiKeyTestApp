...
.method private static a(Landroid/content/Context;Landroid/util/AttributeSet;ZZ)Landroid/content/Context;
    ...
    instance-of v0, p0, Landroid/support/v7/e/d;

    if-eqz v0, :cond_1

    move-object v0, p0

    check-cast v0, Landroid/support/v7/e/d;

    invoke-virtual {v0}, Landroid/support/v7/e/d;->a()I
    ...
    invoke-direct {v0, p0, v1}, Landroid/support/v7/e/d;-><init>(Landroid/content/Context;I)V
...
.method private a(Landroid/view/View;Landroid/util/AttributeSet;)V
    ...
    invoke-static {p1}, Landroid/support/v4/view/r;->y(Landroid/view/View;)Z
...
.method public final a(Landroid/view/View;Ljava/lang/String;Landroid/content/Context;Landroid/util/AttributeSet;ZZZZ)Landroid/view/View;
    ...
    invoke-static {v0}, Landroid/support/v7/widget/bc;->a(Landroid/content/Context;)Landroid/content/Context;
