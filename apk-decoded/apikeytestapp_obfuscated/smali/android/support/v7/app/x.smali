...
.field private static f:Landroid/support/v7/app/x; = null
...
.method static a()Landroid/support/v7/app/x;
    .locals 1

    sget-object v0, Landroid/support/v7/app/x;->f:Landroid/support/v7/app/x;

    if-nez v0, :cond_0

    new-instance v0, Landroid/support/v7/app/x;

    invoke-direct {v0}, Landroid/support/v7/app/x;-><init>()V

    sput-object v0, Landroid/support/v7/app/x;->f:Landroid/support/v7/app/x;
...
.method public a(JDD)V
    ...
    iput v2, p0, Landroid/support/v7/app/x;->e:I

    const-wide/16 v2, -0x1

    iput-wide v2, p0, Landroid/support/v7/app/x;->c:J

    const-wide/16 v2, -0x1

    iput-wide v2, p0, Landroid/support/v7/app/x;->d:J
    ...
    iput-wide v6, p0, Landroid/support/v7/app/x;->c:J
    ...
    iget-wide v2, p0, Landroid/support/v7/app/x;->d:J

    cmp-long v2, v2, p1

    if-gez v2, :cond_2

    iget-wide v2, p0, Landroid/support/v7/app/x;->c:J
