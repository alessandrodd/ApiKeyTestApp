...
.method private b(Landroid/support/v7/app/b;)V
    ...
    iget v1, p1, Landroid/support/v7/app/b;->l:I
    ...
    check-cast v6, Landroid/support/v7/app/b$d;
    ...
    iget v3, p1, Landroid/support/v7/app/b;->m:I

    iget-object v5, p0, Landroid/support/v7/app/b$a;->s:[Ljava/lang/CharSequence;

    move-object v1, p0

    invoke-direct/range {v0 .. v6}, Landroid/support/v7/app/b$a$1;-><init>(Landroid/support/v7/app/b$a;Landroid/content/Context;II[Ljava/lang/CharSequence;Landroid/support/v7/app/b$d;)V
    ...
    :cond_0
    iput-object v0, p1, Landroid/support/v7/app/b;->j:Landroid/widget/ListAdapter;

    iget v0, p0, Landroid/support/v7/app/b$a;->F:I

    iput v0, p1, Landroid/support/v7/app/b;->k:I
    ...
    invoke-virtual {v6, v0}, Landroid/support/v7/app/b$d;->setOnItemClickListener(Landroid/widget/AdapterView$OnItemClickListener;)V
    ...
    invoke-virtual {v6, v0}, Landroid/support/v7/app/b$d;->setOnItemSelectedListener(Landroid/widget/AdapterView$OnItemSelectedListener;)V
    ...
    invoke-virtual {v6, v9}, Landroid/support/v7/app/b$d;->setChoiceMode(I)V

    :cond_3
    :goto_2
    iput-object v6, p1, Landroid/support/v7/app/b;->b:Landroid/widget/ListView;
    ...
    invoke-direct/range {v1 .. v7}, Landroid/support/v7/app/b$a$2;-><init>(Landroid/support/v7/app/b$a;Landroid/content/Context;Landroid/database/Cursor;ZLandroid/support/v7/app/b$d;Landroid/support/v7/app/b;)V
    ...
    iget v2, p1, Landroid/support/v7/app/b;->n:I
    ...
    :cond_6
    iget v2, p1, Landroid/support/v7/app/b;->o:I
    ...
    invoke-direct {v0, p0, v6, p1}, Landroid/support/v7/app/b$a$4;-><init>(Landroid/support/v7/app/b$a;Landroid/support/v7/app/b$d;Landroid/support/v7/app/b;)V
    ...
    invoke-virtual {v6, v0}, Landroid/support/v7/app/b$d;->setChoiceMode(I)V
