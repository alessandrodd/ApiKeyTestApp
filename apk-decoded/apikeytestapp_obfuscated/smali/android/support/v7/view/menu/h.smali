...
.field private s:Landroid/support/v7/view/menu/h$a;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v7/view/menu/h;->n:[I
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Landroid/support/v7/view/menu/h;->H:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/concurrent/CopyOnWriteArrayList;

    invoke-direct {v0}, Ljava/util/concurrent/CopyOnWriteArrayList;-><init>()V

    iput-object v0, p0, Landroid/support/v7/view/menu/h;->I:Ljava/util/concurrent/CopyOnWriteArrayList;

    iput-object p1, p0, Landroid/support/v7/view/menu/h;->o:Landroid/content/Context;

    invoke-virtual {p1}, Landroid/content/Context;->getResources()Landroid/content/res/Resources;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v7/view/menu/h;->p:Landroid/content/res/Resources;
    ...
    iput-object v0, p0, Landroid/support/v7/view/menu/h;->u:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, Landroid/support/v7/view/menu/h;->x:Ljava/util/ArrayList;

    iput-boolean v1, p0, Landroid/support/v7/view/menu/h;->y:Z
...
.method private a(ILjava/lang/CharSequence;ILandroid/graphics/drawable/Drawable;Landroid/view/View;)V
    ...
    iput-object p5, p0, Landroid/support/v7/view/menu/h;->j:Landroid/view/View;

    iput-object v1, p0, Landroid/support/v7/view/menu/h;->h:Ljava/lang/CharSequence;

    iput-object v1, p0, Landroid/support/v7/view/menu/h;->i:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v0, p0, Landroid/support/v7/view/menu/h;->h:Ljava/lang/CharSequence;
    ...
    iput-object v0, p0, Landroid/support/v7/view/menu/h;->i:Landroid/graphics/drawable/Drawable;

    :cond_2
    :goto_2
    iput-object v1, p0, Landroid/support/v7/view/menu/h;->j:Landroid/view/View;
    ...
    iput-object p2, p0, Landroid/support/v7/view/menu/h;->h:Ljava/lang/CharSequence;
    ...
    iput-object p4, p0, Landroid/support/v7/view/menu/h;->i:Landroid/graphics/drawable/Drawable;
...
.method private a(Landroid/support/v7/view/menu/v;Landroid/support/v7/view/menu/p;)Z
    ...
    iget-object v1, p0, Landroid/support/v7/view/menu/h;->I:Ljava/util/concurrent/CopyOnWriteArrayList;
...
.method private e(Landroid/os/Bundle;)V
    ...
    iget-object v0, p0, Landroid/support/v7/view/menu/h;->I:Ljava/util/concurrent/CopyOnWriteArrayList;
...
.method private static g(I)I
    ...
    sget-object v1, Landroid/support/v7/view/menu/h;->n:[I
...
.method private g(Z)V
    ...
    iget-object v1, p0, Landroid/support/v7/view/menu/h;->p:Landroid/content/res/Resources;
...
.method protected a(IIILjava/lang/CharSequence;)Landroid/view/MenuItem;
    ...
    iget v6, p0, Landroid/support/v7/view/menu/h;->z:I
    ...
    iget-object v1, p0, Landroid/support/v7/view/menu/h;->A:Landroid/view/ContextMenu$ContextMenuInfo;
    ...
    :cond_0
    iget-object v1, p0, Landroid/support/v7/view/menu/h;->t:Ljava/util/ArrayList;

    iget-object v2, p0, Landroid/support/v7/view/menu/h;->t:Ljava/util/ArrayList;
...
.method public a(Landroid/support/v7/view/menu/h$a;)V
    ...
    iput-object p1, p0, Landroid/support/v7/view/menu/h;->s:Landroid/support/v7/view/menu/h$a;
...
.method public a(Landroid/support/v7/view/menu/p;)V
    ...
    iget-object v0, p0, Landroid/support/v7/view/menu/h;->o:Landroid/content/Context;
...
.method public a(Landroid/support/v7/view/menu/p;Landroid/content/Context;)V
    ...
    iput-boolean v0, p0, Landroid/support/v7/view/menu/h;->y:Z
...
.method public a(Landroid/view/ContextMenu$ContextMenuInfo;)V
    ...
    iput-object p1, p0, Landroid/support/v7/view/menu/h;->A:Landroid/view/ContextMenu$ContextMenuInfo;
...
.method a(Ljava/util/List;ILandroid/view/KeyEvent;)V
    ...
    invoke-virtual {v0}, Landroid/support/v7/view/menu/k;->getAlphabeticModifiers()I
    ...
    :cond_6
    invoke-virtual {v0}, Landroid/support/v7/view/menu/k;->getNumericModifiers()I
...
.method public a(Z)V
    ...
    iput-boolean v1, p0, Landroid/support/v7/view/menu/h;->E:Z
...
.method a(Landroid/support/v7/view/menu/h;Landroid/view/MenuItem;)Z
    ...
    iget-object v0, p0, Landroid/support/v7/view/menu/h;->s:Landroid/support/v7/view/menu/h$a;
...
.method public add(I)Landroid/view/MenuItem;
    ...
    iget-object v0, p0, Landroid/support/v7/view/menu/h;->p:Landroid/content/res/Resources;
...
.method public addSubMenu(IIILjava/lang/CharSequence;)Landroid/view/SubMenu;
    ...
    iget-object v2, p0, Landroid/support/v7/view/menu/h;->o:Landroid/content/Context;
...
.method public c(Landroid/support/v7/view/menu/k;)Z
    ...
    iput-object p1, p0, Landroid/support/v7/view/menu/h;->J:Landroid/support/v7/view/menu/k;
...
.method public clear()V
    ...
    iget-object v0, p0, Landroid/support/v7/view/menu/h;->J:Landroid/support/v7/view/menu/k;
...
.method public clearHeader()V
    ...
    iput-object v0, p0, Landroid/support/v7/view/menu/h;->j:Landroid/view/View;
...
.method public d(Z)V
    ...
    iput-boolean p1, p0, Landroid/support/v7/view/menu/h;->F:Z
...
.method public d(Landroid/support/v7/view/menu/k;)Z
    ...
    iget-object v1, p0, Landroid/support/v7/view/menu/h;->J:Landroid/support/v7/view/menu/k;
    ...
    iput-object v1, p0, Landroid/support/v7/view/menu/h;->J:Landroid/support/v7/view/menu/k;
...
.method public j()Ljava/util/ArrayList;
    ...
    iget-object v0, p0, Landroid/support/v7/view/menu/h;->u:Ljava/util/ArrayList;
    ...
    iget-object v4, p0, Landroid/support/v7/view/menu/h;->u:Ljava/util/ArrayList;
    ...
    :cond_2
    iput-boolean v2, p0, Landroid/support/v7/view/menu/h;->v:Z
...
.method public k()V
    ...
    iget-object v0, p0, Landroid/support/v7/view/menu/h;->x:Ljava/util/ArrayList;
    ...
    :cond_3
    iget-object v5, p0, Landroid/support/v7/view/menu/h;->x:Ljava/util/ArrayList;
    ...
    :cond_5
    iput-boolean v3, p0, Landroid/support/v7/view/menu/h;->y:Z
...
.method public n()Ljava/lang/CharSequence;
    ...
    iget-object v0, p0, Landroid/support/v7/view/menu/h;->h:Ljava/lang/CharSequence;
...
.method public o()Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Landroid/support/v7/view/menu/h;->i:Landroid/graphics/drawable/Drawable;
...
.method public p()Landroid/view/View;
    ...
    iget-object v0, p0, Landroid/support/v7/view/menu/h;->j:Landroid/view/View;
